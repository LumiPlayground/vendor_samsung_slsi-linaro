...
typedef enum ofi_usr_image_type_e {
  OFI_USR_IMAGE_TYPE_U8 = 0x00,     ///< g eneral data [1BYTE]
  OFI_USR_IMAGE_TYPE_U16,           ///< general data [2BYTE]
  OFI_USR_IMAGE_TYPE_U32,           ///< general data [4BYTE]
  OFI_USR_IMAGE_TYPE_RGB8888,       ///< xRGB8888_1plane
  OFI_USR_IMAGE_TYPE_BGR8888,       ///< xRGB8888_1plane
  OFI_USR_IMAGE_TYPE_RGB888,        ///< RGB888_1plane
  OFI_USR_IMAGE_TYPE_BGR888,        ///< BGR888_1plane
  OFI_USR_IMAGE_TYPE_RGB888_3P,     ///< RGB888_3planes
  OFI_USR_IMAGE_TYPE_BGR888_3P,     ///< BGR888_3planes
  OFI_USR_IMAGE_TYPE_RGBF32_3P,     ///< RGB_3planes / 32bit floats
  OFI_USR_IMAGE_TYPE_BGRF32_3P,     ///< RGB888_3planes / 32bit floats
  OFI_USR_IMAGE_TYPE_YUV422_1P,     ///< YCbCr422 1p
  OFI_USR_IMAGE_TYPE_YUV422_2P,     ///< YCbCr422 2p
  OFI_USR_IMAGE_TYPE_YUV422_3P,     ///< YCbCr422 3p
  OFI_USR_IMAGE_TYPE_YUV420_2P,     ///< YCbCr420 2p
  OFI_USR_IMAGE_TYPE_YUV420_3P,     ///< YCbCr420 3p
  OFI_USR_IMAGE_TYPE_CP_YUV422_2P,  ///< C-plane of YCbCr422 2p
  OFI_USR_IMAGE_TYPE_CP_YUV420_2P,  ///< C-plane of YCbCr420 2p
  OFI_USR_IMAGE_TYPE_NV21,          ///< NV21
 ...
 *
 */
typedef int (*ofi_usr_callback_func_p)(int, int, int, void **);
 ...
 */
extern int ofi_get_model_compiler_version(ofi_model_id model_id, char *ver_char_256);
 ...
 * We recommand use this, but in the special case, the client should use this. (RPC broken)
 * @return returns 0 if success. if err, return negative value
 */
 ...
 * @return int 0 if succeed
 */
extern int ofi_update_image_from_rawfile(ofi_usr_image obj, const char* filename);
 ...
 * @return int 0 if succeed
 */
extern int ofi_get_inbuf_shape_info(ofi_model_id model_id, char *layer_name,
 ...
 * @return int 0 if succeed
 */
extern int ofi_get_inbuf_shape_info_with_idx(
    ofi_model_id model_id, char *layer_name, uint32_t *width, uint32_t *height,
    uint32_t *channel , uint32_t *source_type, uint32_t *source_idx);
/**
 ...
 * @return int 0 if succeed
 */
extern int ofi_get_outbuf_shape_info(ofi_model_id model_id, char *layer_name,
                                     uint32_t *width, uint32_t *height,
                                     uint32_t *channel );
/**
 * @brief get shape information of Out-buffer
 ...
 * @return int 0 if succeed
 */
extern int ofi_get_outbuf_shape_info_with_idx(
    ofi_model_id model_id, char *layer_name, uint32_t *width, uint32_t *height,
    uint32_t *channel , uint32_t *source_type, uint32_t *source_idx);
