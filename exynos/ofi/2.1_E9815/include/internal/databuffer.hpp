...
class DataBuffer : public Buffer {
  public:
     ...
     */
    uint32_t GetSize() { return mRealSize; }
    ...
    bool ReadFromFile(const char *fileName, uint32_t size);
     ...
     */
    bool SetMetaData(uint32_t size, bool allocate_memory=false);
  ...
  private:
    ...
    void Initialize(uint32_t size, bool malloc=false);
