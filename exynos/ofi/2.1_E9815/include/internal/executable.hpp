...
class Executable {
  ...
  public:
     ...
     * @return on Success, true is returned. On failure false is returned.
     */
    virtual bool Load(const char *cgoBuffer, int cgoSize, int *modelId) = 0;
    /**
     * @brief Unload graph.
    ...
    virtual bool SetMemoryToEngine(graph::Graph &graph, int modelId) = 0;
    virtual void
    ...
    virtual bool SetShapeBuffer(int modelId, MemoryInfo memInfo) = 0;
    /**
    ...
    virtual bool ExportTempBuffer(int modelid, const char *file) = 0;
};
}  // namespace system
}  // namespace seva
#endif
