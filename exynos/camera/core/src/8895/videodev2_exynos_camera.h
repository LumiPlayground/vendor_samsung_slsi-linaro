...
struct fd_info {
    int          face_num;
    unsigned int id[CAMERA2_MAX_FACES];
    struct       is_fd_rect rect[CAMERA2_MAX_FACES];
    float        score[CAMERA2_MAX_FACES];
    uint32_t     frame_count;
    float        rotation[CAMERA2_MAX_FACES];
    float        yaw[CAMERA2_MAX_FACES];
    float        pitch[CAMERA2_MAX_FACES];
    uint32_t     width;          /* Original width size */
    uint32_t     height;         /* Original height size */
    uint32_t     crop_x;         /* crop image offset x */
    uint32_t     crop_y;         /* crop image offset y */
    uint32_t     crop_w;         /* crop width size */
    uint32_t     crop_h;         /* crop height size */
};
...
#define V4L2_CID_IS_TUNE_FACTORY_LED_CALIBRATION_ENABLE	(V4L2_CID_FIMC_IS_TUNE_BASE + 5)
#define V4L2_CID_IS_TUNE_FACTORY_LED_CALIBRATION_STROBE_CURRENTS_0	(V4L2_CID_FIMC_IS_TUNE_BASE + 6)
#define V4L2_CID_IS_TUNE_FACTORY_LED_CALIBRATION_STROBE_CURRENTS_1	(V4L2_CID_FIMC_IS_TUNE_BASE + 7)
#define V4L2_CID_IS_TUNE_FACTORY_GYRO_SELF_TEST                     (V4L2_CID_FIMC_IS_TUNE_BASE + 8)
