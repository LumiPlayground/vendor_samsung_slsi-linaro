...
LOCAL_SHARED_LIBRARIES := libbinder libui libutils libcutils liblog libui libcamera_metadata
...
ifeq ($(BOARD_BACK_CAMERA_SENSOR_OPEN), true)
LOCAL_CFLAGS += -DCAMERA_OPEN_ID_REAR_0=0
endif

ifeq ($(BOARD_FRONT_CAMERA_SENSOR_OPEN), true)
ifeq ($(BOARD_BACK_CAMERA_SENSOR_OPEN), false)
LOCAL_CFLAGS += -DCAMERA_OPEN_ID_FRONT_0=0
else
...
LOCAL_CFLAGS += -DCAMERA_OPEN_ID_REAR_1=2
endif
...
LOCAL_CFLAGS += -DCAMERA_OPEN_ID_REAR_2=4
endif
...
LOCAL_CFLAGS += -DCAMERA_OPEN_ID_REAR_3=6
endif
...
LOCAL_SHARED_LIBRARIES := libbinder libui liblog libhardware libutils libion_exynos libhwjpeg libnativewindow
