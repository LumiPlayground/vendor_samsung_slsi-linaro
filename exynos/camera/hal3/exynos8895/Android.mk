...
LOCAL_SHARED_LIBRARIES := libbinder libutils libcutils liblog libui libcamera_metadata libprocessgroup
...
LOCAL_SRC_FILES = \
	...
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraActivityControl.cpp\
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCamera.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraParameters.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraConfigurations.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraSizeControl.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameFactory.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameFactoryPreview.cpp \
	$(CAMERA_SRC_PATH)/hal3/9xxx/ExynosCameraFrameFactoryPreviewVendor.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameFactoryVision.cpp \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameReprocessingFactory.cpp \
...
LOCAL_SRC_FILES += \
	...
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFactoryPlugIn.cpp
endif

ifeq ($(BOARD_CAMERA_USES_DUAL_CAMERA), true)
LOCAL_SRC_FILES += \
    $(CAMERA_SRC_PATH)/core/src/common_v2/Pipes2/ExynosCameraPipeSync.cpp \
    $(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameFactoryPreviewDual.cpp \
    $(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameReprocessingFactoryDual.cpp
endif

ifeq ($(BOARD_CAMERA_USES_REMOSAIC_SENSOR), true)
LOCAL_SRC_FILES += \
	$(CAMERA_SRC_PATH)/core/src/8895/ExynosCameraFrameReprocessingFactoryRemosaic.cpp
endif
...
LOCAL_SHARED_LIBRARIES := libbinder libui liblog libhardware libutils libion_exynos libhwjpeg libnativewindow libprocessgroup
