...
struct ExynosCameraSensorInfoBase *createExynosCameraSensorInfo(int cameraId, __unused int serviceCameraId)
{
    ...
    case SENSOR_NAME_S5K3L2:
        sensorInfo = new ExynosCameraSensor3L2(sensorId);
        snprintf(sensorInfo->name, sizeof(sensorInfo->name), "S5K3L2");
        break;
...
ExynosCameraSensor3L2::ExynosCameraSensor3L2(int sensorId) : ExynosCameraSensor3L2Base(sensorId)
{
    /* Use ExynosCameraSensorS5K3L2Base Constructor */
};

ExynosCameraSensor4H5YC::ExynosCameraSensor4H5YC(int sensorId) : ExynosCameraSensor4H5YCBase(sensorId)
{
    /* Use ExynosCameraSensorS5K4H5YCBase Constructor */
