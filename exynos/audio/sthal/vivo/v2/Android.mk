...
ifeq ($(BOARD_USE_STHAL_VIVO_V2),true)
LOCAL_PATH := $(call my-dir)

include $(CLEAR_VARS)

STHAL_SEC_PATH := $(TOP)/vendor/samsung_slsi/exynos/audio/sthal/vivo
...
LOCAL_SRC_FILES := \
    ...
    ../../unified/v2/sound_trigger_hw.c \
    ../../unified/v2/st_xml_parser.c \
    ../../unified/v2/st_pcm_dump.c \
    ringbuf.c \

LOCAL_C_INCLUDES += \
    external/tinyalsa/include \
    ./ \
    $(STHAL_UNIFIED_PATH)/v2 \
    external/expat/lib
...
ifeq ($(BOARD_USE_STHAL_ODM_SOUND_TRIGGER), true)
LOCAL_CFLAGS += -DODM_SOUND_TRIGGER
