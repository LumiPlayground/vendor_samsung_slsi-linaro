...
/* START [NSQE313] - Add a option to check discovery state of connected tag */
  enum ActivationState { Idle, Sleep, Active, Discovery };
...
/* START [17092801J] Add Tech_Type for WCE  */
  ...
  static const int MAX_NUM_TECHNOLOGY = 16;
#else
  //max number of technologies supported by one or more tags
  static const int MAX_NUM_TECHNOLOGY = 11;
#endif
...
/* START [18042401J] - KOVIO Tag reactive time interval */
  uint16_t mKovioReactiveTimeInterval;
...
/* START [2020021701] - Abnormal T4T Read Patch for ezlink card */
  bool getMultiProtocolTagSupport(void);
