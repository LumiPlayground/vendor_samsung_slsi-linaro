...
#define TARGET_TYPE_SNFC_RFU_01            11
#define TARGET_TYPE_SNFC_RFU_02            12
#define TARGET_TYPE_SNFC_RFU_03            13
#define TARGET_TYPE_SNFC_RFU_04            14

#define TARGET_TYPE_ISO14443_WCE           15
#define ISO14443_WCE_TIMEOUT            30000   // initial timeout value for WCE
#endif
...
//[6. SEID changes]
#define NCI20_SEID_UICC      0x083
#define NCI20_SEID_ESE       0x082

#define NCI10_SEID_UICC      0x03
#define NCI10_SEID_ESE       0x02
/* END [181106] Patch for supporting NCI v2.0 */
/************ HCI ID **************************/
#define HID_UICC      0x02
#define HID_ESE       0x03
/**********************************************/
