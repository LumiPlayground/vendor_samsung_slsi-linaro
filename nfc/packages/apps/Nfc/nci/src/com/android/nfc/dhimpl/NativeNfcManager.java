...
public class NativeNfcManager implements DeviceHost {
    ...
    private native void doShutdown(boolean disableCe);

    @Override
    public void shutdown(boolean disableCe) {
        doShutdown(disableCe);
    }
    ...
    // [SEC] Get default routing destination
    private native int doGetDefaultRoute();
    @Override
    public int getDefaultRoute() {
        return doGetDefaultRoute();
    }

    // [SEC] Set default routing destination
    private native boolean doSetDefaultRoute(int defaultRoute, boolean restart);
    @Override
    public boolean setDefaultRoute(int defaultRoute, boolean restart) {
        return doSetDefaultRoute(defaultRoute, restart);
    }

    // [SEC] Set preferred SIM slot
    private native void doSetPreferredSimSlot(int slotId);
    @Override
    public void setPreferredSimSlot(int preferredSim) {
        doSetPreferredSimSlot(preferredSim);
    }

    // [SEC] Get SIM detection
    private native boolean doGetSimDetection();
    @Override
    public boolean getSimDetection() {
        return doGetSimDetection();
    }

    // [SEC] Set to wait EE discovery
    @Override
    public native void doSetWaitNfcEeDiscovery(boolean isWait);
    ...
    @Override
    public native void doSetRfEnabled(boolean enable);

    // [SEC] Set Firmware Debug Notification Level
    @Override
    public native void doSetFirmwareDebugLevel(int type, boolean enable);

    @Override
    public native boolean doRFoptionUpdate(byte[] path);
    ...
    @Override
    public native void doSetListenTechMask(int techMask);

    @Override
    public native byte[] doSetFactoryTestMode(byte mode);

    @Override
    public native void startRfDiscovery(boolean start);

    @Override
    public native void doSetForceFWDownload(boolean force);
    ...
    private void notifyEeActionProtocolListeners (int handle, int protocol, String buffer) {
        mListener.onEeActionProtocolEvent(handle, protocol, buffer);
    }
