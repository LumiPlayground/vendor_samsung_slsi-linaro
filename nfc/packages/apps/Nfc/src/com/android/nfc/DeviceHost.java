...
public interface DeviceHost {
    public interface DeviceHostListener {
        ...
        public void onEeActionProtocolEvent(int handle, int protocol, String buffer);
    ...
    public void shutdown(boolean disableCe); // [SEC] Lowpower CE disable
    ...
    */
    ...
    public int getDefaultRoute(); // [SEC] Get default route destination

    public boolean setDefaultRoute(int defaultRoute, boolean restart); // [SEC] Set default route destination

    public void setPreferredSimSlot(int slotId); // [SEC] Set preferred SIM

    public boolean getSimDetection(); // [SEC] Get SIM detection

    public void doSetWaitNfcEeDiscovery(boolean isWait); // [SEC] Set to wait EE discovery

    public int[] doGetSecureElementList(); // [SEC] Get SE list

    public void doSetRfEnabled(boolean enable);

    public void doSetFirmwareDebugLevel(int type, boolean enable); // [SEC] Set Firmware Debug Notification Level

    public boolean doRFoptionUpdate(byte[] path);

    public int doGetListenTechMask();

    public void doSetListenTechMask(int techMask);

    public byte[] doSetFactoryTestMode(byte mode);

    public void startRfDiscovery(boolean start);

    public void doSetForceFWDownload(boolean force);
