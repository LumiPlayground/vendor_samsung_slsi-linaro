...
**
** Description      Set flag to wait EE discovery.
**
** Returns          NFA_STATUS_OK if successfully initiated
**                  NFA_STATUS_FAILED otherwise
**
*******************************************************************************/
tNFA_STATUS NFA_SetWaitNfcEeDiscovery(bool is_wait) {
  tNFA_STATUS status = NFA_STATUS_OK;
  extern bool is_wait_ee_discovery;
  is_wait_ee_discovery = is_wait;
  return status;
}
#endif
