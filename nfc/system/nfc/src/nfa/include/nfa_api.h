...
/* START [S19081401] Add the Mifare protocol config */
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
#define NFA_PROTOCOL_MIFARE NFC_PROTOCOL_MIFARE
#endif
/* END [S19081401] Add the Mifare protocol config */
...
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE) /* START_SLSI [S19081401] */
#define NFA_PROTOCOL_MIFARE NFC_PROTOCOL_MIFARE
#endif
...
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
#define NFA_PROTOCOL_MASK_ISO7816 0x20 /* ISO7816 - Aid Default Route */
#endif
...
/* Set listen tech mask event */
#define NFA_SET_LISTEN_TECH_MASK_EVT 41
#endif
...
/*******************************************************************************
**
** Function         NFA_SetPreferredSimSlot
**
...
**
*******************************************************************************/
extern tNFA_STATUS NFA_SetPreferredSimSlot(uint16_t nPreferredSimSlot);
#endif
/* END [P1604040001] - Support Dual-SIM solution */

#ifdef NFC_SEC_NOT_OPEN_INCLUDED
extern tNFA_STATUS NFA_SetListenTechMask(tNFA_TECHNOLOGY_MASK tech_mask);
#endif
