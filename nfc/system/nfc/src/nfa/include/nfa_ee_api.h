...
/*******************************************************************************
**
** Function         [SEC] NFA_SetWaitNfcEeDiscovery
**
** Description      Waiting EE discovery when UICC is changed
**                  to prevent confliction with PIPE creation.
**
** Returns          NFA_STATUS_OK if successfully set
**                  NFA_STATUS_FAILED otherwise
**
*******************************************************************************/
extern tNFA_STATUS NFA_SetWaitNfcEeDiscovery(bool is_wait);
#endif
#endif /* NFA_EE_API_H */
