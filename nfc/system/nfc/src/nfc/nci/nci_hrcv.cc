...
#include "nfc_api.h"
#include "nfc_int.h"
/* START [19040808] Patch for DTA */
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
#ifdef SEC_NFC_DTA_SUPPORT
static uint8_t dta_analog_mode = 0x00;
#endif
#endif
/* END [19040808] Patch for DTA */
...
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
#ifdef SEC_NFC_DTA_SUPPORT
      if (dta_analog_mode == 0xFF) {
        dta_analog_mode = 0x00;
        break;
      }
#endif
#endif
...
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
#ifdef SEC_NFC_DTA_SUPPORT
  if (p[1] == 0x3A) dta_analog_mode = 0xFF;
#endif
#endif
/* END [19040808] Patch for DTA */
