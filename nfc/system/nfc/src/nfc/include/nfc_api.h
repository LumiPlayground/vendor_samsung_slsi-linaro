...
#define NFC_STATUS_WRONG_SIZE_BAD_RESP  0xED
...
typedef struct {
  ...
  uint16_t build_info_high; /* Build Info High Version  */
  uint16_t build_info_low;  /* Build Info Low Version  */
} tNFC_FW_VERSION;
#endif
...
/* START_SLSI [S15110301] Add the Mifare CLT config for N81 or N7 */
#if (NFC_SEC_NOT_OPEN_INCLUDED == TRUE)
#define NFC_PROTOCOL_CLT NCI_PROTOCOL_CLT
#endif
/* END_SLSI [S15110301] Add the Mifare CLT config for N81 or N7 */
...
**
*******************************************************************************/
extern tNFC_FW_VERSION NFC_getFWVersion();
#endif
/* END_SLSI [S14111902] Get a firmware version information (S14111902 , J15052703) */
