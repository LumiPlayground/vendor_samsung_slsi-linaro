...
LOCAL_SRC_PATH := 3830_r_launching
else ifeq ($(ENABLE_R_FEATURE), true)
LOCAL_SRC_PATH := 3830_r_launching
else ifeq ($(ENABLE_T_FEATURE), true)
LOCAL_SRC_PATH := 3830_t_launching
else
LOCAL_SRC_PATH := 3830
endif
...
LOCAL_SRC_FILES := $(LOCAL_SRC_PATH)/$(LOCAL_MODULE_STEM)$(LOCAL_MODULE_SUFFIX)
...
LOCAL_SHARED_LIBRARIES := libMcClient libc libm libdl liblog
