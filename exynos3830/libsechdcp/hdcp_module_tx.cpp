    ...
    :  HDCPModule(cookie, observerNotify)
{
    ...
    mLooper->start(
            ...
            PRIORITY_AUDIO);
    mHDCPTx = this;
    mLooper->registerHandler(mHDCPTx);
}
        ...
        void *outData)
{
    ...
    sp<AMessage> notify = new AMessage(kWhatEncrypt, this);
        ...
        void *outData)
{
    ...
    size_t dataLeng = size;
    uint8_t HDCP_private_data[HDCP_PRIVATE_DATA_LEN];
    status_t err;
    sp<AMessage> response;
    sp<AMessage> notify = new AMessage(kWhatEncryptNative, this);
...
void ExynosHDCPModuleTx::onMessageReceived(
        ...
        case kWhatEncryptNative:
            {
                ...
                hdcpRet = HDCP_TX_Link_encrypt(mLinkHandle,
                        ...
                        (uint32_t)HDCP_PRIVATE_DATA_LEN,
