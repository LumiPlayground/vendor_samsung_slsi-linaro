...
print_help ()
{
    ...
    echo ""
    echo "Options:"
    echo "  -t       : time in seconds (default: 60)"
    echo "  -h / -?  : Display this help"
    echo ""
    echo "Platform:"
    echo "   ramen  : Ramen  erd9610 Board"
    echo "   neus   : Neus   erd9630 Board"
    echo "   orange : Orange erd9815 Board (default)"
    exit 1
}
...
if [[ $# > ${OPTIND} ]]; then
    echo "All options must be specified before target!"
    exit 1
fi
...
elif [ $PLATFORM = neus ] ; then
	F0=($(sed -n '1,11p' /sys/devices/system/cpu/cpu0/cpufreq/stats/time_in_state))
	F4=($(sed -n '1,16p' /sys/devices/system/cpu/cpu6/cpufreq/stats/time_in_state))
elif [ $PLATFORM = orange ] ; then
	F0=($(sed -n '1,16p' /sys/devices/system/cpu/cpu0/cpufreq/stats/time_in_state))
	F4=($(sed -n '1,21p' /sys/devices/system/cpu/cpu4/cpufreq/stats/time_in_state))
	F7=($(sed -n '1,23p' /sys/devices/system/cpu/cpu7/cpufreq/stats/time_in_state))
fi
...
if [ $PLATFORM = ramen ] ; then
	...
	echo "$count,$TX_TPUT,$RX_TPUT,$TEMP_BIG,$TEMP_LITTLE,$FW_CPU,${INTR[1]},${INTR[2]},${INTR[3]},${INTR[4]},${INTR[5]},${INTR[6]},${INTR[7]},${INTR[8]},,${C0[3]},${C0[7]},${C0[4]},$TC0,${C1[3]},${C1[7]},${C1[4]},$TC1,${C2[3]},${C2[7]},${C2[4]},$TC2,${C3[3]},${C3[7]},${C3[4]},$TC3,${C4[3]},${C4[7]},${C4[4]},$TC4,${C5[3]},${C5[7]},${C5[4]},$TC5,${C6[3]},${C6[7]},${C6[4]},$TC6,${C7[3]},${C7[7]},${C7[4]},$TC7,,${F0[0]},${F0[1]},${F0[2]},${F0[3]},${F0[4]},${F0[5]},${F0[6]},${F0[7]},${F0[8]},${F0[9]},${F0[10]},${F0[11]},${F0[12]},${F0[13]},${F0[14]},${F0[15]},${F0[16]},${F0[17]},${F0[18]},${F0[19]},${F0[20]},${F0[21]},${F4[0]},${F4[1]},${F4[2]},${F4[3]},${F4[4]},${F4[5]},${F4[6]},${F4[7]},${F4[8]},${F4[9]},${F4[10]},${F4[11]},${F4[12]},${F4[13]},${F4[14]},${F4[15]},${F4[16]},${F4[17]},${F4[18]},${F4[19]},${F4[20]},${F4[21]},${F4[22]},${F4[23]},${F4[24]},${F4[25]},${F4[26]},${F4[27]},${F4[28]},${F4[29]},${F4[30]},${F4[31]}"
elif [ $PLATFORM = orange ] ; then
	echo "$count,$TX_TPUT,$RX_TPUT,$TEMP_BIG,$TEMP_LITTLE,$FW_CPU,${INTR[1]},${INTR[2]},${INTR[3]},${INTR[4]},${INTR[5]},${INTR[6]},${INTR[7]},${INTR[8]},,${C0[3]},${C0[7]},${C0[4]},$TC0,${C1[3]},${C1[7]},${C1[4]},$TC1,${C2[3]},${C2[7]},${C2[4]},$TC2,${C3[3]},${C3[7]},${C3[4]},$TC3,${C4[3]},${C4[7]},${C4[4]},$TC4,${C5[3]},${C5[7]},${C5[4]},$TC5,${C6[3]},${C6[7]},${C6[4]},$TC6,${C7[3]},${C7[7]},${C7[4]},$TC7,,${F0[0]},${F0[1]},${F0[2]},${F0[3]},${F0[4]},${F0[5]},${F0[6]},${F0[7]},${F0[8]},${F0[9]},${F0[10]},${F0[11]},${F0[12]},${F0[13]},${F0[14]},${F0[15]},${F0[16]},${F0[17]},${F0[18]},${F0[19]},${F0[20]},${F0[21]},${F0[22]},${F0[23]},${F0[24]},${F0[25]},${F0[26]},${F0[27]},${F0[28]},${F0[29]},${F0[30]},${F0[31]},${F4[0]},${F4[1]},${F4[2]},${F4[3]},${F4[4]},${F4[5]},${F4[6]},${F4[7]},${F4[8]},${F4[9]},${F4[10]},${F4[11]},${F4[12]},${F4[13]},${F4[14]},${F4[15]},${F4[16]},${F4[17]},${F4[18]},${F4[19]},${F4[20]},${F4[21]},${F4[22]},${F4[23]},${F4[24]},${F4[25]},${F4[26]},${F4[27]},${F4[28]},${F4[29]},${F4[30]},${F4[31]},${F4[32]},${F4[33]},${F4[34]},${F4[35]},${F4[36]},${F4[37]},${F4[38]},${F4[39]},${F4[40]},${F4[41]},${F7[0]},${F7[1]},${F7[2]},${F7[3]},${F7[4]},${F7[5]},${F7[6]},${F7[7]},${F7[8]},${F7[9]},${F7[10]},${F7[11]},${F7[12]},${F7[13]},${F7[14]},${F7[15]},${F7[16]},${F7[17]},${F7[18]},${F7[19]},${F7[20]},${F7[21]},${F7[22]},${F7[23]},${F7[24]},${F7[25]},${F7[26]},${F7[27]},${F7[28]},${F7[29]},${F7[30]},${F7[31]},${F7[32]},${F7[33]},${F7[34]},${F7[35]},${F7[36]},${F7[37]},${F7[38]},${F7[39]},${F7[40]},${F7[41]},${F7[42]},${F7[43]},${F7[44]},${F7[45]}"
fi
