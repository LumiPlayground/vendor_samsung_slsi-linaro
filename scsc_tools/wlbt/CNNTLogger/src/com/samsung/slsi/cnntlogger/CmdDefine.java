...
final class CmdDefine {
    ...
    static final String SYSTEM_PROPERTY_LOGGING_PATH = "vendor.wlbtlog.path";
    static final String SYSTEM_PROPERTY_SDCARD_PATH = "vendor.sdcard.path.log";
    static final String SDCARD_DEFAULT_DIR = "/sdcard/bbklog/";
    static final String SABLE_LOG_DIR = "/data/vendor/log/wifi/";
    static final String SDCARD_SYSTEM_DEFAULT_DIR = "/sdcard/CNNTLog/";

    static final String SDCARD_DIR = "/storage/sdcard/log/CNNTLog";
    static final String dirPath = "/data/vendor/log/wlbt/";
    static final String systemDirPath = "/data/log/wifi/";
    static final String mHip4Path = "hip4/";
    ...
    static final String KEY_BT_FILTER_PREV_VAL = "Pref_BtFilter_Prev_Value";
    ...
    static final String StartScriptBT = "start";
    static final String StopScriptBT = "stop";

    static final long STORAGE_SIZE_2GB = 2 * 1024 * 1024; // 2,097,152KB

    //udi_log
    static final String udiLog = "slsi_wlan_udi_log stdout | slsi_wlan_udi_log_decode stdin > ";

    //logcat
    static final String lcLog = "logcat -v threadtime";
    ...
    static final String wifiHip4 = "hip4";
    ...
    static final int WIFI_LOG_GET_HIP4 = 6;

    static final int BT_LOG_NORMAL = 7;
    static final int BT_LOG_AUDIO = 8;
    static final int BT_LOG_CUSTOM = 9;
    static final int BT_LOG_STOP = 10;
