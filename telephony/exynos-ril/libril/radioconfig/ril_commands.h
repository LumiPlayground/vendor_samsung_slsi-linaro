...
*/
    ...
    {RIL_REQUEST_SET_MODEMS_CONFIG, radioconfig::setModemsConfigResponse},
    {RIL_REQUEST_GET_MODEMS_CONFIG, radioconfig::getModemsConfigResponse},
    /* 1.2 */
    {RIL_REQUEST_GET_SLOT_STATUS, radioconfig::getSimSlotsStatusResponse_1_2},
    /* 1.3 */
