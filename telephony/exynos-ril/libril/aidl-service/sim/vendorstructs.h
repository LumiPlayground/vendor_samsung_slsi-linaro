...
::aidl::android::hardware::radio::sim::AppStatus toAidl(const RIL_AppStatus& info);
::aidl::android::hardware::radio::sim::CardStatus toAidl(const sim::V2_0::RIL_CardStatus& info);
}
