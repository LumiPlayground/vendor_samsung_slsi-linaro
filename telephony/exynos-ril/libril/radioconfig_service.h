...
android::sp<::android::hardware::radio::config::V1_0::IRadioConfig> getRadioConfig();
...
android::sp<::android::hardware::radio::config::V1_1::IRadioConfig> make(uint32_t slotId);
} // namespace radioconfig
