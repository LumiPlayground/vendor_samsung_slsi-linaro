...
addRequestToList(int serial, int slotId, int request) {
    ...
    pRI->token = serial;
    pRI->pCI = android::getCommandInfo(slotId, request);
    if (pRI->pCI == NULL || pRI->pCI->responseFunction == NULL) {
        RLOGE("Unsupported request ID %s(%d)", requestToString(request), request);
        free(pRI);
        return NULL;
    }
...
#endif
#endif
    int ret = pthread_mutex_lock(pendingRequestsMutexHook);
    assert (ret == 0);
...
eventLoop(void *param) {
    ...
    ret = fcntl(s_fdWakeupRead, F_SETFL, O_NONBLOCK);
    if (ret < 0) {
        RLOGE("Error in fcntl() errno:%d", errno);
    }
...
RIL_register (const RIL_RadioFunctions *callbacks) {
    ...
    radio::registerService(&s_callbacks);
    radioconfig::registerService(&s_callbacks, NULL);
    RLOGI("RIL_register called registerService");
...
/* RIL vendor external */
extern "C" void
RIL_External_register (const RIL_RadioExternalFunctions *callbacks) {
    radioExternal::registerService(callbacks);
}
...
#endif
{
    ...
    UnsolResponseInfo *unsolResponseHook = android::getUnsolRespInfo(soc_id, unsolResponse);
    if (unsolResponseHook == NULL || unsolResponseHook->responseFunction == NULL) {
    ...
    switch (unsolResponseHook->wakeType) {
        case WAKE_PARTIAL:
            grabPartialWakeLock();
    ...
    int responseType;
    if (s_callbacks.version >= 13
                && unsolResponseHook->wakeType == WAKE_PARTIAL) {
    ...
    if (unsolResponse == RIL_UNSOL_NITZ_TIME_RECEIVED) {
        ...
        assert(rwlockRet == 0);
        radio::setNitzTimeReceived((int)soc_id, OsalUtils::elapsedRealtime());
    } else {
        rwlockRet = pthread_rwlock_rdlock(radioServiceRwlockPtr);
        assert(rwlockRet == 0);
    }

    if (unsolResponseHook->responseFunction) {
        ret = unsolResponseHook->responseFunction(
...
*/
    switch(request) {
        ...
        case RIL_REQUEST_SUPPLY_SIM_DEPERSONALIZATION: return "SUPPLY_SIM_DEPERSONALIZATION";
        case RIL_REQUEST_GET_SLOT_STATUS: return "GET_SLOT_STATUS";
        case RIL_REQUEST_SET_LOGICAL_TO_PHYSICAL_SLOT_MAPPING: return "SET_LOGICAL_TO_PHYSICAL_SLOT_MAPPING";
        ...
        case RIL_REQUEST_ENABLE_UICC_APPLICATIONS: return "ENABLE__UICC_APPLICATIONS";
        case RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT: return "GET_UICC_APP_ENABLEMENT";
        ...
        case RIL_REQUEST_ENABLE_NR_DUAL_CONNECTIVITY: return "RIL_REQUEST_ENABLE_NR_DUAL_CONNECTIVITY";
        case RIL_REQUEST_IS_NR_DUAL_CONNECTIVITY_ENABLED: return "RIL_REQUEST_IS_NR_DUAL_CONNECTIVITY_ENABLED";
        case RIL_REQUEST_SET_DATA_THROTTLING: return "RIL_REQUEST_SET_DATA_THROTTLING";
        case RIL_REQUEST_SLICING_CONFIG: return "RIL_REQUEST_SLICING_CONFIG";
        case RIL_REQUEST_ALLOCATE_PDU_SESSION_ID: return "RIL_REQUEST_ALLOCATE_PDU_SESSION_ID";
        case RIL_REQUEST_RELEASE_PDU_SESSION_ID: return "RIL_REQUEST_RELEASE_PDU_SESSION_ID";
        case RIL_REQUEST_START_HANDOVER: return "RIL_REQUEST_START_HANDOVER";
        case RIL_REQUEST_CANCEL_HANDOVER: return "RIL_REQUEST_CANCEL_HANDOVER";
        case RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS: return "RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS";
        case RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP: return "RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP";
        case RIL_REQUEST_GET_ALLOWED_NETWORK_TYPES_BITMAP: return "RIL_REQUEST_GET_ALLOWED_NETWORK_TYPES_BITMAP";
        case RIL_REQUEST_GET_SIM_PHONEBOOK_RECORDS: return "RIL_REQUEST_GET_SIM_PHONEBOOK_RECORDS";
        case RIL_REQUEST_UPDATE_SIM_PHONEBOOK_RECORDS: return "RIL_REQUEST_UPDATE_SIM_PHONEBOOK_RECORDS";
        case RIL_REQUEST_GET_SIM_PHONEBOOK_CAPACITY: return "RIL_REQUEST_GET_SIM_PHONEBOOK_CAPACITY";
        ...
        case RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_CHANGED: return "RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_CHANGED";
        case RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_RECORDS_RECEIVED: return "RIL_UNSOL_RESPONSE_SIM_PHONEBOOK_RECORDS_RECEIVED";
        ...
        case RIL_UNSOL_REGISTRATION_FAILED: return "UNSOL_REGISTRATION_FAILED";
        case RIL_UNSOL_BARRING_INFO_CHANGED: return "UNSOL_BARRING_INFO_CHANGED";
        case RIL_UNSOL_UNTHROTTLE_APN: return "UNSOL_UNTHROTTLE_APN";
        // S.LSI Extension Request ID
        case RIL_REQUEST_SWITCH_VOICE_CALL: return "RIL_REQUEST_SWITCH_VOICE_CALL";
        case RIL_REQUEST_QUERY_COLP: return "RIL_REQUEST_QUERY_COLP";
        case RIL_REQUEST_QUERY_COLR: return "RIL_REQUEST_QUERY_COLR";
        case RIL_REQUEST_GET_ALLOW_DATA_STATE: return "RIL_REQUEST_GET_ALLOW_DATA_STATE";
        case RIL_UNSOL_SUPP_SVC_RETURN_RESULT: return "RIL_UNSOL_SUPP_SVC_RETURN_RESULT";
        ...
        case RIL_REQUEST_SET_UPLMN: return "RIL_REQUEST_SET_UPLMN";
        case RIL_REQUEST_GET_UPLMN: return "RIL_REQUEST_GET_UPLMN";
        case RIL_REQUEST_SET_CALL_CONFIRM: return "RIL_REQUEST_SET_CALL_CONFIRM";
        case RIL_REQUEST_SEND_CALL_CONFIRM: return "RIL_REQUEST_SEND_CALL_CONFIRM";
        case RIL_REQUEST_SET_DS_NETWORK_TYPE: return "RIL_REQUEST_SET_DS_NETWORK_TYPE";
        case RIL_UNSOL_CALL_PRESENT_IND: return "UNSOL_CALL_PRESENT_IND";
        case RIL_UNSOL_WB_AMR_REPORT_IND: return "RIL_UNSOL_WB_AMR_REPORT_IND";
        case RIL_UNSOL_NAS_TIMER_STATUS_IND: return "RIL_UNSOL_NAS_TIMER_STATUS_IND";
        case RIL_REQUEST_SET_WBAMR_CAPABILITY: return "RIL_REQUEST_SET_WBAMR_CAPABILITY";
        case RIL_REQUEST_GET_WBAMR_CAPABILITY: return "RIL_REQUEST_GET_WBAMR_CAPABILITY";
        case RIL_REQUEST_GET_DUPLEX_MODE: return "RIL_REQUEST_GET_DUPLEX_MODE";
        case RIL_REQUEST_SET_DUPLEX_MODE: return "RIL_REQUEST_SET_DUPLEX_MODE";
        ...
        case RIL_REQUEST_QUERY_AVAILABLE_EMERGENCY_CALL_STATUS: return "RIL_REQUEST_QUERY_AVAILABLE_EMERGENCY_CALL_STATUS";
        case RIL_REQUEST_SET_EMERGENCY_CALL_STATUS: return "RIL_REQUEST_SET_EMERGENCY_CALL_STATUS";
        case RIL_UNSOL_EMERGENCY_ACT_INFO: return "RIL_UNSOL_EMERGENCY_ACT_INFO";
        case RIL_REQUEST_SET_FEMTO_CELL_SRCH: return "RIL_REQUEST_SET_FEMTO_CELL_SRCH";
        case RIL_REQUEST_SET_CDMA_HYBRID_MODE: return "RIL_REQUEST_SET_CDMA_HYBRID_MODE";
        case RIL_REQUEST_GET_CDMA_HYBRID_MODE: return "RIL_REQUEST_GET_CDMA_HYBRID_MODE";
        case RIL_UNSOL_ICCID_INFO: return "RIL_UNSOL_ICCID_INFO";
        case RIL_UNSOL_EMERGENCY_SUPPORT_RAT_MODE: return "RIL_UNSOL_EMERGENCY_SUPPORT_RAT_MODE";
        case RIL_REQUEST_GET_SIM_LOCK_STATUS: return "RIL_REQUEST_GET_SIM_LOCK_STATUS";
        case RIL_UNSOL_ON_USSD_WITH_DCS: return "UNSOL_ON_USSD_WITH_DCS";
        case RIL_REQUEST_DIAL_WITH_CALL_TYPE: return "DIAL_WITH_CALL_TYPE";
        case RIL_REQUEST_SET_VOICE_OPERATION: return "SET_VOICE_OPERATION";
        case RIL_REQUEST_SET_DUAL_NETWORK_AND_ALLOW_DATA: return "SET_DUAL_NETWORK_AND_ALLOW_DATA";
        case RIL_REQUEST_DEACTIVATE_DATA_CALL_WITH_REASON: return "RIL_REQUEST_DEACTIVATE_DATA_CALL_WITH_REASON";
        case RIL_REQUEST_CHANGE_BARRING_PASSWORD_OVER_MMI: return "CHANGE_BARRING_PASSWORD_OVER_MMI";
        case RIL_REQUEST_QUERY_BPLMN_SEARCH: return "QUERY_BPLMN_SEARCH";
        case RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL_WITH_RAT: return "SET_NETWORK_SELECTION_MANUAL_WITH_RAT";
        case RIL_REQUEST_SET_ACTIVATE_VSIM: return "RIL_REQUEST_SET_ACTIVATE_VSIM";
        case RIL_REQUEST_SET_ENDC_MODE: return "RIL_REQUEST_SET_ENDC_MODE";
        case RIL_REQUEST_GET_ENDC_MODE: return "RIL_REQUEST_GET_ENDC_MODE";
        case RIL_REQUEST_GET_SMS_STORAGE_ON_SIM: return "GET_SMS_STORAGE_ON_SIM";
        case RIL_REQUEST_SET_NR_MODE: return "RIL_REQUEST_SET_NR_MODE";
        case RIL_REQUEST_GET_NR_MODE: return "RIL_REQUEST_GET_NR_MODE";
