...
struct HidlHalSimResponse_1_6 : public HidlHalResponse_1_6, public CheckReturnStatus {
    using HidlHalResponse_1_6::HidlHalResponse_1_6;

    HidlHalSimResponse_1_6(const HidlHalResponse_1_6& hidlHal) : HidlHalResponse_1_6(hidlHal) {}
    ...
    int getSimPhonebookRecordsResponse(int slotId,
                           int responseType, int serial, RIL_Errno e,
                           void *response, size_t responseLen);
    int setSimCardPowerResponse_1_6(int slotId,
                           int responseType, int serial, RIL_Errno e,
                           void *response, size_t responseLen);
