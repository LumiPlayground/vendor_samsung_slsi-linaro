...
struct HidlHalDataResponse_1_6 : public HidlHalResponse_1_6,
                                 public CheckReturnStatus {
  using HidlHalResponse_1_6::HidlHalResponse_1_6;

  HidlHalDataResponse_1_6(const HidlHalResponse_1_6 &hidlHal)
  ...
  int getDataCallListResponse_1_6(int slotId, int responseType, int serial,
                                  RIL_Errno e, void *response,
                                  size_t responselen);

  int getSlicingConfigResponse_1_6(int slotId, int responseType, int serial,
                                   RIL_Errno e, void *response,
                                   size_t responselen);
  ...
  int releasePduSessionIdResponse(int slotId, int responseType, int serial,
                                      RIL_Errno e, void *response,
                                      size_t responselen);
  int setupDataCallResponse_1_6(int slotId, int responseType, int serial,
                                RIL_Errno e, void *response,
                                size_t responselen);
