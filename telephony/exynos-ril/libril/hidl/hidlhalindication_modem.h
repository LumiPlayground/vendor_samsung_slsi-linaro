...
struct HidlHalModemIndication : public HidlHalIndication, public CheckReturnStatus {
    using HidlHalIndication::HidlHalIndication;

    HidlHalModemIndication(const HidlHalIndication& hidlHal) : HidlHalIndication(hidlHal) {}
