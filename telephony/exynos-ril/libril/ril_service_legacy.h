...
#ifndef RIL_SERVICE_LEGACY_H
#define RIL_SERVICE_LEGACY_H
...
android::sp<::android::hardware::radio::V1_5::IRadio> make(uint32_t slotId);
void checkReturnStatus(int32_t slotId, ::android::hardware::Return<void>& ret);

}  // namespace legacy
}  // namespace impl

void sendEmergencyDial(int32_t serial, const android::hardware::radio::V1_0::Dial &dialInfo,
                       android::hardware::hidl_bitfield<android::hardware::radio::V1_4::EmergencyServiceCategory> categories,
                       const android::hardware::hidl_vec<android::hardware::hidl_string> &urns, android::hardware::radio::V1_4::EmergencyCallRouting routing,
...
// radio 1.2
///////////////////////////////////////////////////////////////////////////
int getIccCardStatusResponse_1_2(int slotId, int responseType,
                            int serial, RIL_Errno e, void *response, size_t responselen);

int getCurrentCallsResponse_1_2(int slotId,
                           int responseType, int serial, RIL_Errno e, void *response,
                           size_t responselen);
...
int getSignalStrengthResponse_1_2(int slotId, int responseType,
                            int serial, RIL_Errno e, void *response, size_t responselen);
...
// radio 1.4
///////////////////////////////////////////////////////////////////////////
int getIccCardStatusResponse_1_4(int slotId, int responseType,
                            int serial, RIL_Errno e, void *response, size_t responselen);
...
int getSignalStrengthResponse_1_4(int slotId, int responseType,
                            int serial, RIL_Errno e, void *response, size_t responselen);

int setupDataCallResponse_1_4(int slotId,
                          int responseType, int serial, RIL_Errno e, void *response,
                          size_t responseLen);

int getDataCallListResponse_1_4(int slotId,
                            int responseType, int serial, RIL_Errno e,
                            void *response, size_t responseLen);
...
int currentEmergencyNumberListInd(int slotId,
                          int indicationType, int token, RIL_Errno e, void *response,
                          size_t responselen);
...
int setupDataCallResponse_1_5(int slotId,
                            int responseType, int serial, RIL_Errno e, void *response,
                            size_t responselen);

int setInitialAttachApnResponse_1_5(int slotId,
                            int responseType, int serial, RIL_Errno e, void *response,
                            size_t responselen);

int setDataProfileResponse_1_5(int slotId,
                            int responseType, int serial, RIL_Errno e, void *response,
                            size_t responselen);
...
int getDataCallListResponse_1_5(int slotId,
                            int responseType, int serial, RIL_Errno e,
                            void *response, size_t responseLen);

int getIccCardStatusResponse_1_5(int slotId, int responseType,
                            int serial, RIL_Errno e, void *response, size_t responselen);

int uiccApplicationsEnablementChangedInd(int slotId,
                            int indicationType, int token, RIL_Errno e, void *response,
                            size_t responselen);
...
void constructCdmaSms(RIL_CDMA_SMS_Message &rcsm, const android::hardware::radio::V1_0::CdmaSmsMessage& sms);
...
bool convertHalDataProfileToRil(RIL_DataProfileInfo_V1_4& out,
        const android::hardware::radio::V1_4::DataProfileInfo& dataProfileInfo,
        android::RequestInfo *pRI);
bool convertHalDataProfileToRil(RIL_DataProfileInfo_V1_5& out,
        const android::hardware::radio::V1_5::DataProfileInfo& dataProfileInfo,
        android::RequestInfo *pRI);
bool convertHalLinkAddressToRil(RIL_LinkAddress& out,
        const android::hardware::radio::V1_5::LinkAddress& linkAddress,
        android::RequestInfo *pRI);

bool fillSetupDataCallInfo_V1_5(RIL_SetupDataCallInfo_V1_5 &setupDataCallInfo,
        ...
        const android::hardware::hidl_vec<android::hardware::hidl_string>& dnses, android::RequestInfo *pRI);

void freeSetupDataCallInfo_V1_5(RIL_SetupDataCallInfo_V1_5 &setupDataCallInfo,
                                   const android::hardware::hidl_vec<android::hardware::radio::V1_5::LinkAddress>& addresses);

void populateResponseInfo(android::hardware::radio::V1_0::RadioResponseInfo& responseInfo,
        int serial, int responseType, RIL_Errno e);

int responseInt(android::hardware::radio::V1_0::RadioResponseInfo& responseInfo, int serial,
        int responseType, RIL_Errno e, void *response, size_t responseLen);

android::hardware::radio::V1_0::SendSmsResult makeSendSmsResult(android::hardware::radio::V1_0::RadioResponseInfo& responseInfo,
