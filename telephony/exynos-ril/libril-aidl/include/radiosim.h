...
struct RadioSim : public aidl::android::hardware::radio::sim::BnRadioSim {
    std::shared_ptr<RadioSimCallback> mRadio;
    uint32_t mSlot;
    RadioCallbackManager<RadioSimCallback, RadioSimResponseCallback,
                RadioSimIndicationCallback> mCallbacks;

    RadioSim(std::shared_ptr<RadioSimCallback> radio, uint32_t slot);
    ...
    static std::shared_ptr<RadioSim> make(std::shared_ptr<RadioSimCallback> radio, uint32_t slot);
};
