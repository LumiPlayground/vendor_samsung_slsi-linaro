...
struct RadioDataIndication : public RadioDataIndicationCallback,
                            public RadioReturnStatus,
                            public RemoteDiedHelper {
    std::shared_ptr<::aidl::android::hardware::radio::data::IRadioDataIndication> mIndication;
    ...
    void setResponseFunction(const std::shared_ptr<::aidl::android::hardware::radio::data::IRadioDataIndication>& radioDataIndication);
