...
/**
 * RIL_REQUEST_SET_UPLMN - deprecated
 *
 * Modify UPLMN list.
 *
 * "data" is const char **
...
/**
 * RIL_REQUEST_GET_UPLMN - deprecated
 *
 * Query UPLMN list
 *
  * "data" is NULL
...
/**
 * RIL_LOCAL_REQUEST_VSIM_NOTIFICATION - deprecated, OEM path is used.
 *
 *
 *
...
/**
 * RIL_LOCAL_REQUEST_VSIM_OPERATION - deprecated, OEM path is used.
 *
 *
 *
...
/*
 * RIL_REQUEST_EMULATE_IND  -- deprecated
 *
...
/**
  * RIL_REQUEST_SET_NR_MODE
  *
  * enable/disable NR mode
  *
  * "data" is int
  * "response" is NULL
  *
  ...
  *  REQUEST_NOT_SUPPORTED
  */
#define RIL_REQUEST_SET_NR_MODE (RIL_REQUEST_EXTENSION_BASE+46)

/**
  * RIL_REQUEST_GET_NR_MODE
  *
  * get the current NR mode
  *
  * "data" is NULL
  * "response" is int
  *
  ...
  *  REQUEST_NOT_SUPPORTED
  */
#define RIL_REQUEST_GET_NR_MODE (RIL_REQUEST_EXTENSION_BASE+47)
/***********************************************************************/
...
/**
 * RIL_UNSOL_VSIM_OPERATION_INDICATION - deprecated, OEM path is used.
 *
 *
 *
 * "data" is RIL_VsimOperationEvent
 ...
 * "data" is int *
 * ((int *)data)[0] is == 0x01 : Disable ENDC capability
 * ((int *)data)[0] is == 0x02 : Enable ENDC capability
 */
#define RIL_UNSOL_IND_ENDC_CAPABILITY (RIL_UNSOL_EXTENSION_BASE+14)

/**
 * RIL_UNSOL_IND_SIM_TRAY_STATUS_CHANGED
 * This message is used to indicate SIM Tray state so that AP will know SIM tray is inserted/removed based on
 * "Data" is int *
 * ((int *)data)[0] is == 0x0 : SIM Tray is unknown state
 * ((int *)data)[0] is == 0x1 : SIM Tray is inserted
 * ((int *)data)[0] is == 0x2 : SIM Tray is removed
 */
#define RIL_UNSOL_IND_SIM_TRAY_STATUS_CHANGED (RIL_UNSOL_EXTENSION_BASE+15)

/**
 * RIL_UNSOL_IND_POST_URSP
 * This message is used to post Ursp upto framework when it's received from network
 * "Data" is same to Extended SlicingConfigResponse of vendor::radio package
 */
#define RIL_UNSOL_IND_POST_URSP (RIL_UNSOL_EXTENSION_BASE + 16)
