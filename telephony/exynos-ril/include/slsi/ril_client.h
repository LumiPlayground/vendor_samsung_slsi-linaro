...
#define RILC_STATUS_MISSING_RESOURCE                        6    /* no logical channel available */
#define RILC_STATUS_NO_SUCH_ELEMENT                         7    /* application not found on SIM */
#define RILC_STATUS_INTERNAL_ERR                            8    /* Modem hit unexpected error scenario while handling this request */
#define RILC_STATUS_NO_MEMORY                               9    /* Not sufficient memory to process the request */
#define RILC_STATUS_MISSING_RESOURCES                       10   /* no logical channel available */
#define RILC_STATUS_CANCELLED                               11
#define RILC_STATUS_SIM_ERR                                 12   /* Received error from SIM card */
#define RILC_STATUS_INVALID_SIM_STATE                       13   /* Can not process the request in current SIM state */
#define RILC_STATUS_FDN_CHECK_FAILURE                       14   /* Can not process the request in current SIM state */
#define RILC_STATUS_REQUEST_NOT_SUPPORTED                   15
#define RILC_STATUS_SIMULTANEOUS_SMS_AND_CALL_NOT_ALLOWED   67   /* 1X voice and SMS are not allowed simulteneously */
...
#define RILC_REQ_SET_AP_SYSTEM_TIME             42
#define RILC_REQ_SET_NR_MODE                    43
#define RILC_REQ_GET_NR_MODE                    44
#define RILC_REQ_SET_VOICE_OPERATION            45
#define RILC_REQ_GET_VOICE_OPERATION            46
#define RILC_REQ_GET_SIGNAL_STRENGTH            47
#define RILC_REQ_SET_IMS_REGISTRATION_STATE     48
#define RILC_REQ_SET_NR_SILENCE_MODE            49
#define RILC_REQ_SET_URSP                       50
#define RILC_REQ_SET_EMC_LAB_TEST_MODE          51
#define RILC_REQ_GET_NR_SILENCE_MODE            52
#define RILC_REQ_SET_VONR_CAPA                  57
#define RILC_REQ_GET_VONR_CAPA                  58
#define RILC_REQ_SET_MOBILE_DATA_STATE          59

#define RILC_REQ_SET_PLMN_LIST                  71
#define RILC_REQ_GET_PLMN_LIST                  72
...
#define RILC_REQ_AIMS_AT_CMD_FORWARDING          149
#define RILC_REQ_AIMS_CALL_TRANSFER              150
#define RILC_REQ_AIMS_COMMON_IMS_SVC_INFO        161
/* Call Deflection */
#define RILC_REQ_AIMS_CALL_DEFLECTION_REQ        170
#define RILC_REQ_AIMS_COMPOSER_MMTEL             171
#define RILC_REQ_AIMS_CANCEL_COMPOSER_MMTEL      172
#define RILC_REQ_AIMS_SET_RTP_HEADER_EXTENSION_TYPE     173
#define RILC_REQ_AIMS_SEND_RTP_HEADER_EXTENSION         174
#define RILC_REQ_AIMS_SEND_UL_SIP_MSG_IND        180
#define RILC_REQ_AIMS_DL_SIP_MSG_RESULT_IND      181
#define RILC_REQ_AIMS_REGISTER_IND               182
#define RILC_REQ_AIMS_EMERGENCY_VOWIFI_CAPABILITY 184
//AIMS support end ---------------------
...
// DC
#define RILC_REQ_AIMS_DC_SESSION_UPDATE          154
#define RILC_REQ_AIMS_DC_SESSION_MANAGE          155
#define RILC_REQ_AIMS_DC_SESSION_MODIFY_IND      156
...
#define RILC_REQ_GPS_SET_GNSS_BLANKING                  (RILC_REQ_GPS_BASE + 26)
...
#define RILC_REQ_GPS_SET_GNSS_BLANKING_TDL              (RILC_REQ_GPS_BASE + 27)
#define RILC_REQ_GPS_GET_SIM_STATE                      (RILC_REQ_GPS_BASE + 28)
#define RILC_REQ_GPS_GET_NETWORK_TYPE                   (RILC_REQ_GPS_BASE + 29)
#define RILC_REQ_GPS_IS_CAMPING_ON_LTE                  (RILC_REQ_GPS_BASE + 30)
...
#define RILC_REQ_SE_RESET                               (RILC_REQ_SE_BASE + 6)
...
/* BIP Channer Manager */
#define RILC_REQ_BIPCHMGR_BASE                          330
#define RILC_REQ_BIPCHMGR_MEDIA_STATUS_RESPONSE         (RILC_REQ_BIPCHMGR_BASE)
#define RILC_REQ_BIPCHMGR_CHANNEL_STATUS_REPORT         (RILC_REQ_BIPCHMGR_BASE + 1)
#define RILC_REQ_BIPCHMGR_OPEN_CHANNEL_RESPONSE         (RILC_REQ_BIPCHMGR_BASE + 2)
#define RILC_REQ_BIPCHMGR_SEND_DATA_RESPONSE            (RILC_REQ_BIPCHMGR_BASE + 3)
#define RILC_REQ_BIPCHMGR_RECEIVE_DATA_RESPONSE         (RILC_REQ_BIPCHMGR_BASE + 4)
#define RILC_REQ_BIPCHMGR_CLOSE_CHANNEL_RESPONSE        (RILC_REQ_BIPCHMGR_BASE + 5)
...
#define RILC_REQ_AIMS_ENRICHED_CALLING                  561
...
#define RILC_REQ_GET_MODEM_ACTIVITY_INFO                614
#define RILC_REQ_SET_SVN                                615
#define RILC_REQ_SET_FORBID_FREQUENCY                   616
#define RILC_REQ_SET_FORBID_LTE_BAND                    617
#define RILC_REQ_SET_FORBID_LTE_TAC                     618
#define RILC_REQ_SET_SELFLOG_TCP_DUMP_MODE              619
#define RILC_REQ_SET_ALL_DIV_SETTING                    620
#define RILC_REQ_SET_BSR_PARA                           621
#define RILC_REQ_SET_DRDV                               622
#define RILC_REQ_SET_AHEAD_RRE                          623
#define RILC_REQ_SET_FORBID_NR_CELL                     624
#define RILC_REQ_GET_CDMA_CAPABILITY_INFO               625
#define RILC_REQ_SET_WIFI_STATUS                        626
#define RILC_REQ_SET_SRS_PWR_LIMIT                      627
#define RILC_REQ_SET_TRACE_DUMP_CFG                     628
#define RILC_REQ_GET_TRACE_DUMP_CFG                     629
#define RILC_REQ_SET_UE_OPERATION_MODE                  630
#define RILC_REQ_GET_UE_OPERATION_MODE                  631
#define RILC_REQ_SET_NRRRM_MIN_REQ_ENABLE               634
#define RILC_REQ_GET_NRRRM_MIN_REQ_ENABLE               635
#define RILC_REQ_SET_PWR_DETECT_THR                     636
#define RILC_REQ_SET_VCRT                               637
#define RILC_REQ_SET_ENABLE_N28                         638
#define RILC_REQ_SET_UL_MIMO                            639
#define RILC_REQ_GET_BINARY_VERSION_INFO                640
#define RILC_REQ_GET_VCRT                               642
#define RILC_REQ_SET_NR_DISABLE_BAND                    643

#define RILC_REQ_CHANGE_BARRING_PASSWORD_OVER_MMI       700
...
#define RILC_REQ_MISC_SEND_TEST_JSON_DATA               811

#define RILC_REQ_IMS_SIP_MESSAGE                        830
#define RILC_REQ_IMS_SET_SRVCC_CALL_INFO                831
#define RILC_REQ_IMS_UPDATE_IMS_REGISTRATION_INFO       832
#define RILC_REQ_IMS_START_IMS_TRAFFIC                  833
#define RILC_REQ_IMS_STOP_IMS_TRAFFIC                   834
#define RILC_REQ_IMS_TRIGGER_EPS_FALLBACK               836
#define RILC_REQ_IMS_MT_CALL_GUARDTMR_STATUS_IND        837

/*REQ IMS MEDIA HAL*/
#define RILC_REQ_IMS_TEST_RCM                           850
#define RILC_REQ_IMS_MEDIA_INIT                         851
#define RILC_REQ_IMS_MEDIA_OPEN_SESSION                 852
#define RILC_REQ_IMS_MEDIA_CLOSE_SESSION                853
#define RILC_REQ_IMS_MEDIA_MODIFY_SESSION               854
#define RILC_REQ_IMS_MEDIA_SEND_DTMF                    855
#define RILC_REQ_IMS_MEDIA_START_DTMF                   856
#define RILC_REQ_IMS_MEDIA_STOP_DTMF                    857
#define RILC_REQ_IMS_MEDIA_SEND_TEXT                    858
#define RILC_REQ_IMS_MEDIA_SEND_HEADER_EXTENSION        859
#define RILC_REQ_IMS_MEDIA_SET_MEDIA_QUALITY_THRESHOLD  860
#define RILC_REQ_IMS_MEDIA_GET_OPERATION_MODE           861
#define RILC_REQ_IMS_MEDIA_WIFI_CONFIG                  862
#define RILC_REQ_IMS_MEDIA_QUERY_MAC_CE_INFO            863

#define RILC_REQ_UPDATE_EMERGENCY_NUMBER_LIST           903
#define RILC_REQ_AIMS_SET_TEMP_EMERGENCY_NUMBER         950

#define RILC_REQ_MISC_SET_TELEPHONY_STATUS_LOGGING      989
#define RILC_REQ_MISC_TEST_UNSOL                        990

/* UNSOLICITED */
#define RILC_UNSOL_DISCONNECTED                    1000    /* RIL disconnected */
#define RILC_UNSOL_NOT_SUPPORTED                   1001    /* not supported */
#define RILC_UNSOL_RADIO_STATE_CHANGED             1002    /* radio state changed. See RIL_RadioState in ril.h */
#define RILC_UNSOL_CONNECTED                       1003    /* RIL connected */
#define RILC_UNSOL_MODEM_STATE_CHANGED             1004    /* modem state(crash/recovery) */
#define RILC_UNSOL_LAST_CALL_FAIL_CAUSE            1005    /* the last call failure cause */
#define RILC_UNSOL_NAS_TIMER_STATUS                1007
...
#define RILC_UNSOL_LTE_RRC_STATE_CHANGED           2010
#define RILC_UNSOL_TOTAL_OOS                       2011
#define RILC_UNSOL_DEVICE_RESET                    2012
#define RILC_UNSOL_PS_DATA_OFF_STATUS              2013
#define RILC_UNSOL_SIM_OPERATOR_NUMERIC            2014    /* SIM MCC/MNC configured */
#define RILC_UNSOL_BARRING_INFO_LOCATION_SANTIZED  2015
#define RILC_UNSOL_PHYSICAL_CHANNEL_CONFIGS        2016

#define RILC_UNSOL_IMS_BEARER_INFO                 3001    /* Sending bearer information to IMS*/
...
#define RILC_UNSOL_AIMS_AT_CMD_FORWARDING          3053
#define RILC_UNSOL_AIMS_FEAT_SUPP                  3054
#define RILC_UNSOL_AIMS_EXPIRE_INFO                3055
#define RILC_UNSOL_AIMS_CALL_TRANSFER_RSP          3056
#define RILC_UNSOL_AIMS_CALL_TRANSFER              3057
#define RILC_UNSOL_AIMS_EMERGENCY_NUMBER_LIST      3058
#define RILC_UNSOL_AIMS_SIP_CONFIG                 3059
#define RILC_UNSOL_AIMS_UL_SIP_MSG_RESULT          3060
#define RILC_UNSOL_AIMS_SEND_DL_SIP_MSG            3061
#define RILC_UNSOL_AIMS_MWI_INFO                   3062
#define RILC_UNSOL_AIMS_COMPOSER_MMTEL             3063
#define RILC_UNSOL_AIMS_RTP_HEADER_EXTENSION_TYPE  3064
#define RILC_UNSOL_AIMS_RTP_HEADER_EXTENSION       3065
#define RILC_UNSOL_AIMS_CODEC_INFO                 3066
#define RILC_UNSOL_AIMS_DC_SESS_UPDATE             3067
#define RILC_UNSOL_AIMS_DC_SESSION_MANAGE          3068
#define RILC_UNSOL_AIMS_DC_SESS_MODIFY             3069

#define RILC_UNSOL_AIMS_ENRICHED_CALLING           3070
#define RILC_UNSOL_AIMS_RADIO_POWER_STATE          3071
...
/*IMS MEDIA HAL*/
#define RILC_UNSOL_IMS_MEDIA_HAL_BASE                       3530
#define RILC_UNSOL_IMS_TEST_RCM                             (RILC_UNSOL_IMS_MEDIA_HAL_BASE)
#define RILC_UNSOL_IMS_MEDIA_ON_DTMF_RECEIVED               (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 1)
#define RILC_UNSOL_IMS_MEDIA_ON_TEXT_RECEIVED               (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 2)
#define RILC_UNSOL_IMS_MEDIA_ON_HEADER_EXTENSION_RECEIVED   (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 3)
#define RILC_UNSOL_IMS_MEDIA_ON_FIRST_MEDIA_RECEIVED        (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 4)
#define RILC_UNSOL_IMS_MEDIA_NOTIFY_MEDIA_INACTIVITY        (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 5)
#define RILC_UNSOL_IMS_MEDIA_NOTIFY_PACKET_LOSS             (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 6)
#define RILC_UNSOL_IMS_MEDIA_NOTIFY_JITTER                  (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 7)
#define RILC_UNSOL_IMS_MEDIA_ON_CALL_QUALITY_CHANGED        (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 8)
#define RILC_UNSOL_IMS_MEDIA_TRIGGER_ANBR_QUERY             (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 9)
#define RILC_UNSOL_IMS_MEDIA_MAC_CE_INFO                    (RILC_UNSOL_IMS_MEDIA_HAL_BASE + 10)

#define RILC_UNSOL_IMS_TRIGGER_IMS_DEREGISTRATION           3550
#define RILC_UNSOL_IMS_CONNECTION_SETUP_FAILURE             3551
#define RILC_UNSOL_IMS_TRIGGER_EPS_FALLBACK                 3553
#define RILC_UNSOL_IMS_MT_CSFB                              3554
...
#define RILC_UNSOL_GPS_CAMPING_ON_LTE                       (RILC_UNSOL_GPS_BASE + 22)
...
#define RILC_UNSOL_BASESTATION_INFO                         5106
#define RILC_UNSOL_DROPPED_MT_CALL_INFO                     5107
...
/* Secure Element */
#define RILC_UNSOL_SE_SIM_STATE_CHANGED                     8050

/* BIP Channer Manager */
#define RILC_UNSOL_BIPCHMGR_BASE                            8100
#define RILC_UNSOL_BIPCHMGR_MEDIA_STATUS_REQUEST            (RILC_UNSOL_BIPCHMGR_BASE)
#define RILC_UNSOL_BIPCHMGR_OPEN_CHANNEL_REQUEST            (RILC_UNSOL_BIPCHMGR_BASE + 1)
#define RILC_UNSOL_BIPCHMGR_SEND_DATA_REQUEST               (RILC_UNSOL_BIPCHMGR_BASE + 2)
#define RILC_UNSOL_BIPCHMGR_RECEIVE_DATA_REQUEST            (RILC_UNSOL_BIPCHMGR_BASE + 3)
#define RILC_UNSOL_BIPCHMGR_CLOSE_CHANNEL_REQUEST           (RILC_UNSOL_BIPCHMGR_BASE + 4)

/* CP carrier config */
#define RILC_UNSOL_CP_CARRIER_CONFIG_CHANGED                9000
