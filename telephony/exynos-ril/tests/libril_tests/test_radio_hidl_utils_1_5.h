 ...
 */
/*
 * test_radio_response_1_5.h
 *
 *  Created on: 2021. 7. 21.
 */
#ifndef __TEST_RADIO_HIDL_UTILS_1_5_H__
#define __TEST_RADIO_HIDL_UTILS_1_5_H__
...
struct TestRadioResponseBase_1_5 : public ::android::hardware::radio::V1_5::IRadioResponse {
    TestRadioResponseBase_1_5() = default;
    virtual ~TestRadioResponseBase_1_5() = default;
    ...
    /* 1.3 Api */
    virtual Return<void> setSystemSelectionChannelsResponse(const RadioResponseInfo& info);

    virtual Return<void> enableModemResponse(const RadioResponseInfo& info);

    virtual Return<void> getModemStackStatusResponse(const RadioResponseInfo& info, const bool enabled);

    /* 1.4 Api */
    virtual Return<void> emergencyDialResponse(const RadioResponseInfo& info);

    virtual Return<void> startNetworkScanResponse_1_4(const RadioResponseInfo& info);
    ...
    virtual Return<void> setPreferredNetworkTypeBitmapResponse(const RadioResponseInfo& info);
    ...
    virtual Return<void> setAllowedCarriersResponse_1_4(const RadioResponseInfo& info);

    virtual Return<void> getAllowedCarriersResponse_1_4(const RadioResponseInfo& info,
                                                const CarrierRestrictionsWithPriority& carriers,
                                                SimLockMultiSimPolicy multiSimPolicy);

    /* 1.5 Api */
    virtual Return<void> setSignalStrengthReportingCriteriaResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> setLinkCapacityReportingCriteriaResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> enableUiccApplicationsResponse(const RadioResponseInfo& info);

    virtual Return<void> areUiccApplicationsEnabledResponse(const RadioResponseInfo& info, bool enabled);

    virtual Return<void> canToggleUiccApplicationsEnablementResponse(const RadioResponseInfo& info,
                                                             bool canToggle);

    virtual Return<void> setSystemSelectionChannelsResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> startNetworkScanResponse_1_5(const RadioResponseInfo& info);
    ...
    virtual Return<void> setInitialAttachApnResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> setDataProfileResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> setRadioPowerResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> setIndicationFilterResponse_1_5(const RadioResponseInfo& info);
    ...
    virtual Return<void> setNetworkSelectionModeManualResponse_1_5(const RadioResponseInfo& info);

    virtual Return<void> sendCdmaSmsExpectMoreResponse(const RadioResponseInfo& info,
...
struct TestRadioIndicationBase_1_5 : public ::android::hardware::radio::V1_5::IRadioIndication {
    TestRadioIndicationBase_1_5() = default;
    virtual ~TestRadioIndicationBase_1_5() = default;
...
#endif /* __TEST_RADIO_HIDL_UTILS_1_5_H__ */
