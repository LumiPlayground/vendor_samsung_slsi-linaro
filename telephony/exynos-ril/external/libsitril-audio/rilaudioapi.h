...
/* for unit test */
/**
 * RilAudioOpenUnitTest
 * @description open communication channel between Audio HAL and RIL for unit test
 * @return returns RILC_UnitTestFunctions*, otherwise null ptr
 */
const void* RilAudioOpenUnitTest(const struct RILC_EnvUnitTest *env);
