...
/**
 * RILC_REQ_GPS_IS_CAMPING_ON_LTE
 *
 * ((int *)data)[0] : 0 camping on others, 1 camping on LTE
 * ((int *)data)[1] : 0 not registered, 1 registered
 */
...
/* related SIM */
#define RILC_UNSOL_SIM_OPERATOR_NUMERIC                     2014
