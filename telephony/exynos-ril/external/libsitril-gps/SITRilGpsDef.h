...
/*=================================================================================
    ...
    SIT_SET_GNSS_BLANKING (RCM ID = 0x0C2C)
...
typedef struct
{
    u8 rat;
    u8 enable;
    sitGnssBlankingInfo blanking_info[MAX_BAND_NUM];
} sitSetGnssBlankingType;


/*=================================================================================

    SIT_SET_GNSS_BLANKING_TDL (RCM ID = 0x0C2D)

==================================================================================*/
typedef struct
{
    u16 t_dl;
} sitSetGnssBlankingTdlType;
