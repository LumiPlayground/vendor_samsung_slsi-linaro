...
class GsmSmsAddress
{
    ...
    public:
        ...
        GsmSmsAddress(const GsmSmsAddress &) = delete;
        GsmSmsAddress& operator=(GsmSmsAddress const&) = delete;
...
class SmsCenter
{
    ...
    public:
        ...
        SmsCenter(const SmsCenter &) = delete;
        SmsCenter& operator=(SmsCenter const&) = delete;
        virtual ~SmsCenter();
        char * ToHexString();
        bool UseRilSmsc();
};
...
class SmsMessage : public RequestData
{
    ...
    public:
        ...
        SmsMessage& operator=(SmsMessage const&) = delete;
        virtual ~SmsMessage();
        void Init();
...
class GsmSmsMessage : public SmsMessage
{
    ...
    public:
        ...
        GsmSmsMessage(const GsmSmsMessage &) = delete;
        GsmSmsMessage& operator=(GsmSmsMessage const&) = delete;
...
class SmsAcknowledge : public RequestData
{
    ...
    public:
        ...
        SmsAcknowledge(const SmsAcknowledge &) = delete;
        SmsAcknowledge& operator=(SmsAcknowledge const&) = delete;
        virtual int encode(char *data, unsigned int datalen);
};
...
class SmsAcknowledgePdu : public RequestData
{
    ...
    public:
        SmsAcknowledgePdu();
        SmsAcknowledgePdu(const SmsAcknowledgePdu &) = delete;
        SmsAcknowledgePdu& operator=(SmsAcknowledgePdu const&) = delete;
        virtual ~SmsAcknowledgePdu();
...
class BroadcastSmsConfigs
{
    ...
    public:
        ...
        BroadcastSmsConfigs& operator=(BroadcastSmsConfigs const&) = delete;
...
class BroadcastSmsConfigsRequestData : public RequestData
{
    ...
    public:
        ...
        BroadcastSmsConfigsRequestData(const BroadcastSmsConfigsRequestData &) = delete;
        BroadcastSmsConfigsRequestData& operator=(BroadcastSmsConfigsRequestData const&) = delete;
