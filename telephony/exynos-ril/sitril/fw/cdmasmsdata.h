...
class CCdmaSmsMessage
{
    ...
    public:
        ...
        CCdmaSmsMessage& operator=(CCdmaSmsMessage const&) = delete;
...
class CdmaSmsRequestData : public RequestData
{
    ...
    public:
        ...
        CdmaSmsRequestData(const CdmaSmsRequestData &) = delete;
        CdmaSmsRequestData& operator=(CdmaSmsRequestData const&) = delete;
...
class CCdmaBroadcastSmsConfigs
{
    ...
    public:
        ...
        CCdmaBroadcastSmsConfigs& operator=(CCdmaBroadcastSmsConfigs const&) = delete;
...
class CdmaBroadcastSmsConfigsRequestData : public RequestData
{
    ...
    public:
        ...
        CdmaBroadcastSmsConfigsRequestData(const CdmaBroadcastSmsConfigsRequestData &) = delete;
        CdmaBroadcastSmsConfigsRequestData& operator=(CdmaBroadcastSmsConfigsRequestData const&) = delete;
