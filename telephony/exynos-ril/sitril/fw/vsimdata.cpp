...
{
    const int minVsimOperationDataLen = sizeof(int) * 4;
    if((data == nullptr) || (length == 0) || (length < minVsimOperationDataLen)) return -1;
