...
public:
    ...
    const RilData *BuildSimDepersonalizationResponse(int nPersoType, int nRemainCount);
    ...
    const RilData *BuildPbCapaResponse(int* pbCapa);
    ...
    const RilData *BuildGetCarrierRestrictionsResponse(int nAllowedLength, RIL_Carrier *pAllowed, int nExcludedLength, RIL_Carrier *pExcluded,
