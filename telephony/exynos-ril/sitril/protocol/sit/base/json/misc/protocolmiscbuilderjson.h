...
/*
 * protocolmiscbuilderjson.h
 *
 *  Created on: 2021. 07. 19.
 *      Author: p1.bansal
 */

#ifndef __PROTOCOL_MISC_BUILDER_JSON_H__
#define __PROTOCOL_MISC_BUILDER_JSON_H__
 ...
 */
class ProtocolDtmfBuilderJson : public ProtocolJsonBuilder, public ProtocolDtmfBuilderInterface {
  public:
    ProtocolDtmfBuilderJson() = default;
    virtual ~ProtocolDtmfBuilderJson() = default;
 ...
 */
class ProtocolMiscBuilderJson : public ProtocolJsonBuilder, public ProtocolMiscBuilderInterface {
  public:
    ProtocolMiscBuilderJson() = default;
    virtual ~ProtocolMiscBuilderJson() = default;
 ...
 */
class ProtocolDeviceInfoBuilderJson : public ProtocolJsonBuilder, public ProtocolDeviceInfoBuilderInterface {
  public:
    ProtocolDeviceInfoBuilderJson() = default;
    virtual ~ProtocolDeviceInfoBuilderJson() = default;
 ...
 */
class ProtocolSensorBuilderJson : public ProtocolJsonBuilder, public ProtocolSensorBuilderInterface {
  public:
    ProtocolSensorBuilderJson() = default;
    virtual ~ProtocolSensorBuilderJson() = default;
 ...
 */
class ProtocolMiscNetworkBuilderJson : public ProtocolJsonBuilder, public ProtocolMiscNetworkBuilderInterface {
  public:
    ProtocolMiscNetworkBuilderJson() = default;
    virtual ~ProtocolMiscNetworkBuilderJson() = default;
 ...
 */
class ProtocolOemOmaDmBuilderJson : public ProtocolJsonBuilder, public ProtocolOemOmaDmBuilderInterface {
  public:
    ProtocolOemOmaDmBuilderJson() = default;
    virtual ~ProtocolOemOmaDmBuilderJson() = default;
 ...
 */
class ProtocolMiscDebugBuilderJson : public ProtocolJsonBuilder, public ProtocolMiscDebugBuilderInterface {
  public:
    ProtocolMiscDebugBuilderJson() = default;
    virtual ~ProtocolMiscDebugBuilderJson() = default;
...
#endif /* __PROTOCOL_MISC_BUILDER_JSON_H__ */
