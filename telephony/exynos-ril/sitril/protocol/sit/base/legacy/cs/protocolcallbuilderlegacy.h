...
/*
 * protocolcallbuilderlegacy.h
 *
 *  Created on: 2014. 12. 2.
 *      Author: sungwoo48.choi
 */

#ifndef __PROTOCOL_CALL_BUILDER_LEGACY_H__
#define __PROTOCOL_CALL_BUILDER_LEGACY_H__
 ...
 */
class ProtocolCallBuilderLegacy : public ProtocolBuilder, public ProtocolCallBuilderInterface {
  public:
    ProtocolCallBuilderLegacy()
        : ProtocolBuilder(), ProtocolCallBuilderInterface() {}
    virtual ~ProtocolCallBuilderLegacy() = default;
...
#endif /* __PROTOCOL_CALL_BUILDER_LEGACY_H__ */
