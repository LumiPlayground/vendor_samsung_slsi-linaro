...
/*
 * protocolsmsbuilderlegacy.h
 *
 *  Created on: 2014. 12. 2.
 *      Author: sungwoo48.choi
 */

#ifndef __PROTOCOL_SMS_BUILDER_LEGACY_H__
#define __PROTOCOL_SMS_BUILDER_LEGACY_H__

#include "protocolbuilder.h"
#include "protocolsmsbuilderinterface.h"

class ProtocolSmsBuilderLegacy : public ProtocolSmsBuilderInterface, public ProtocolBuilder {
  public:
    ProtocolSmsBuilderLegacy()
        : ProtocolSmsBuilderInterface(), ProtocolBuilder() {}
    virtual ~ProtocolSmsBuilderLegacy() {}
...
#endif /* __PROTOCOL_SMS_BUILDER_LEGACY_H__ */
