...
/*
 * protocolsimbuilderlegacy.h
 *
 *  Created on: 2014. 6. 28.
 *      Author: MOX
 */

#ifndef __PROTOCOL_SIM_BUILDER_LEGACY_H__
#define __PROTOCOL_SIM_BUILDER_LEGACY_H__

#include "protocolbuilder.h"
#include "protocolsimbuilderinterface.h"

class ProtocolSimBuilderLegacy : public ProtocolSimBuilderInterface, public ProtocolBuilder {
    typedef enum {
        PIN1_PUK1 = 0,
        PIN2_PUK2
    } SIM_PIN_PUK_INDEX;
  ...
  public:
    ProtocolSimBuilderLegacy()
        : ProtocolSimBuilderInterface(), ProtocolBuilder() {}
    virtual ~ProtocolSimBuilderLegacy() {}
...
#endif /* __PROTOCOL_SIM_BUILDER_LEGACY_H__ */
