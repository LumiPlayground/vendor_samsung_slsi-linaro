...
class ProtocolStkBuilder : public ProtocolStkBuilderInterface
{
private:
    ProtocolStkBuilderInterface *protocolStkBuilderInterface = NULL;

public:
    ProtocolStkBuilder();
    ProtocolStkBuilder(const ProtocolStkBuilder&) = delete;
    ProtocolStkBuilder& operator=(ProtocolStkBuilder const&) = delete;
