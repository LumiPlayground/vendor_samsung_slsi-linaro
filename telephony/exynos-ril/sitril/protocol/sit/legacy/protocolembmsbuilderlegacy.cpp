...
#include "protocolembmsbuilderlegacy.h"
#include "modemdata.h"
#include "rillog.h"
...
ModemData *ProtocolEmbmsBuilderLegacy::BuildSetService(int state)
{
...
char *ProtocolEmbmsBuilderLegacy::getStringTypeTmgi(uint64_t tmgi) {
...
ModemData *ProtocolEmbmsBuilderLegacy::BuildSetSession(int state, uint64_t tmgi, int saiListLen, const uint32_t *pSaiList, int freqListLen, const uint32_t *pFreqList)
{
...
ModemData *ProtocolEmbmsBuilderLegacy::BuildGetSessionList(int state)
{
...
ModemData *ProtocolEmbmsBuilderLegacy::BuildSignalStrength()
{
...
ModemData *ProtocolEmbmsBuilderLegacy::BuildNetworkTime()
{
    null_data_format req;
    int length = sizeof(null_data_format);
    memset(&req, 0, length);
