...
class ProtocolSimBuilder : public ProtocolSimBuilderInterface
{
private:
    ProtocolSimBuilderInterface *protocolSimBuilderInterface = NULL;

public:
    ProtocolSimBuilder();
    ProtocolSimBuilder(const ProtocolSimBuilder&) = delete;
    ProtocolSimBuilder& operator=(ProtocolSimBuilder const&) = delete;
