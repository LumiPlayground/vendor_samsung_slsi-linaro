...
public:
    RadioControlMessageMgr(const RadioControlMessageMgr &) = delete;
    RadioControlMessageMgr& operator=(RadioControlMessageMgr const&) = delete;
...
public:
    ...
    static INT32 DumpDataStatic(char *buffer, UINT32 bufLen, BOOL rx, const char *ioname, int printSimIo);
    int Start();
    void Run();
