...
RouteMap s_ProtocolServiceMap = {
    ...
    { SIT_IND_DSDS_STATUS, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_IND_DSDS_STATUS ) },
    ...
    { SIT_OEM_IND_SIM_PIN_ENC, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_IND_ENCRYPTED_PIN ) },
    // Radio Config
    { SIT_IND_SIM_SLOT_STATUS_CHANGED, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_SLOT_STATUS_CHANGED ) },

    // SIM Tray Status
    { SIT_IND_SIM_TRAY_STATUS_CHANGED, std::make_pair(RIL_SERVICE_SIM, MSG_IND_SIM_TRAY_STATUS ) },

    //NR SA SSC MODE
    { SIT_IND_IP_ADDR_STATUS, std::make_pair(RIL_SERVICE_PS, MSG_PS_IND_ADDR_STATUS ) },
    ...
    { SIT_IND_AIMS_EXPIRE_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_EXPIRE_INFO ) },
    ...
    { SIT_IND_AIMS_AT_CMD_FORWARDING, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_AT_CMD_FORWARDING) },
    { SIT_IND_AIMS_FEAT_SUPP, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_FEAT_SUPP) },
    { SIT_IND_AIMS_CALL_TRANSFER_RSP, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_CALL_TRANSFER_RSP) },
    { SIT_IND_AIMS_CALL_TRANSFER, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_CALL_TRANSFER) },
    { SIT_IND_AIMS_MWI_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_MWI_INFO) },
    { SIT_IND_AIMS_COMPOSER_MMTEL, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_COMPOSER_MMTEL) },
    { SIT_IND_AIMS_ENRICHED_CALLING, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_ENRICHED_CALLING) },
    { SIT_IND_AIMS_RTP_HEADER_EXTENSION_TYPE, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_RTP_HEADER_EXTENSION_TYPE) },
    { SIT_IND_AIMS_RTP_HEADER_EXTENSION, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_RTP_HEADER_EXTENSION) },
    { SIT_IND_AIMS_CODEC_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_CODEC_INFO) },
    { SIT_IND_AIMS_SIP_CONFIG, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_SIP_CONFIG) },
    { SIT_IND_AIMS_UL_SIP_MSG_RESULT, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_UL_SIP_MSG_RESULT) },
    { SIT_IND_AIMS_SEND_DL_SIP_MSG, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_SEND_DL_SIP_MSG) },
    { SIT_IND_AIMS_DC_SESS_UPDATE, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_DC_SESS_UPDATE) },
    { SIT_IND_AIMS_DC_SESSION_MANAGE, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_DC_SESS_MANAGE) },
    { SIT_IND_AIMS_DC_SESS_MODIFY,std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_DC_SESS_MODIFY) },
    ...
    /* BIP Channel Manager */
    { SIT_IND_STK_WIFI_STATUS_REQUEST, std::make_pair(RIL_SERVICE_STK, MSG_SAT_IND_WIFI_STATUS_REQUEST) },
    { SIT_IND_STK_OPEN_CHANNEL_REQUEST, std::make_pair(RIL_SERVICE_STK, MSG_SAT_IND_WIFI_OPEN_CHANNEL_REQUEST) },
    { SIT_IND_STK_SEND_DATA_TO_WIFI, std::make_pair(RIL_SERVICE_STK, MSG_SAT_IND_WIFI_SEND_DATA_REQUEST) },
    { SIT_IND_STK_RECEIVE_DATA_FROM_WIFI, std::make_pair(RIL_SERVICE_STK, MSG_SAT_IND_WIFI_RECEIVE_DATA_REQUEST) },
    { SIT_IND_STK_CLOSE_CHANNEL_REQUEST, std::make_pair(RIL_SERVICE_STK, MSG_SAT_IND_WIFI_CLOSE_CHANNEL_REQUEST) },

    { SIT_IND_ENTER_EMERGENCY_CB_MODE, std::make_pair(RIL_SERVICE_CSC, MSG_CS_IND_ENTER_EMERGENCY_CB_MODE_NTF) },
    { SIT_IND_EXIT_EMERGENCY_CB_MODE, std::make_pair(RIL_SERVICE_CSC, MSG_CS_IND_EXIT_EMERGENCY_CB_MODE_NTF) },
    ...
    { SIT_IND_RF_CONNECTION, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_RF_CONNECTION_STATE_IND) },
    ...
    { SIT_IND_RRC_INFO, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_RRC_INFO) },
    { SIT_IND_REG_FAILED, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_IND_REG_FAILED) },
    { SIT_IND_BARRING_INFO_CHANGED, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_IND_BARRING_INFO) },
    { SIT_OEM_IND_BASESTATION_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_IND_BASESTATION_INFO) },
    { SIT_OEM_IND_DROPPED_MT_CALL_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_IND_DROPPED_MT_CALL_INFO) },
    { SIT_IND_UNTHROTTLE_APN, std::make_pair(RIL_SERVICE_PS, MSG_PS_IND_UNTHROTTLE_APN) },
    { SIT_IND_SLICING_CONFIG, std::make_pair(RIL_SERVICE_PS, MSG_PS_SLICING_CONFIG_UPDATED) },

    /* SAP */
    { SIT_IND_SAP_DISCONNECT, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_DISCONNECT_IND) },
    { SIT_IND_SAP_STATUS, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_STATUS_IND) },

    { SIT_IND_PS_DATA_OFF_STATUS, std::make_pair(RIL_SERVICE_PS, MSG_IND_PS_DATA_OFF_STATUS) },

    { SIT_IND_CARRIER_CONFIG_STATUS, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_CARRIER_CONFIG_STATUS_IND) },
    { SIT_IND_CARRIER_CONFIG_SIM_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_CARRIER_CONFIG_SIM_INFO_IND) },

    // IMS MEDIA
    { SIT_IND_IMS_MEDIA_TEST_RCM, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_IMS_TEST_CMD) },
    { SIT_IND_IMS_MEDIA_ON_DTMF_RECEIVED, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_ON_DTMF_RECEIVED) },
    { SIT_IND_IMS_MEDIA_ON_TEXT_RECEIVED, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_ON_TEXT_RECEIVED) },
    { SIT_IND_IMS_MEDIA_ON_HEADER_EXTENSION_RECEIVED, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_ON_HEADER_EXTENSION_RECEIVED) },
    { SIT_IND_IMS_MEDIA_ON_FIRST_MEDIA_RECEIVED, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_ON_FIRST_MEDIA_RECEIVED) },
    { SIT_IND_IMS_MEDIA_NOTIFY_MEDIA_INACTIVITY, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_NOTIFY_MEDIA) },
    { SIT_IND_IMS_MEDIA_NOTIFY_PACKET_LOSS, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_NOTIFY_PACKET_LOSS) },
    { SIT_IND_IMS_MEDIA_NOTIFY_JITTER, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_NOTIFY_JITTER) },
    { SIT_IND_IMS_MEDIA_ON_CALL_QUALITY_CHANGED, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_ON_CALL_QUALITY_CHANGED) },
    { SIT_IND_IMS_MEDIA_TRIGGER_AMBR_QUERY,std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MEDIA_TRIGGER_AMBR_QUERY) },

    { SIT_IND_IMS_DEREGISTERTAION, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_UNSOL_TRIGGER_IMS_DEREGISTRATION) },
    { SIT_IND_IMS_RRC_CONNECTION_FAILURE, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_UNSOL_CONNECTION_SETUP_FAILURE) },
    { SIT_SET_TRIGGER_EPSFB, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_TRIGGER_EPS_FALLBACK) },
    { SIT_IND_MAC_CE_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_IND_MAC_CE_INFO) },
    { SIT_IND_MT_CSFB, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_IND_MT_CSFB) },
};
