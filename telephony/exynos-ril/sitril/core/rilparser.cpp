...
static ParseFuncMap_t szParseFuncTable[] =
{
    ...
    {RIL_REQUEST_SET_LOGICAL_TO_PHYSICAL_SLOT_MAPPING, RilParser::CreateSlotPortMapping},
    {RIL_REQUEST_ENABLE_UICC_APPLICATIONS, RilParser::CreateInt},
    {RIL_REQUEST_SUPPLY_SIM_DEPERSONALIZATION, RilParser::CreateStrings},
    ...
    // Network
    {RIL_REQUEST_RADIO_POWER, RilParser::CreateInts},
    ...
    {RIL_REQUEST_SET_NETWORK_SELECTION_MANUAL, RilParser::CreateStrings},   // AOSP, PLMN + RAN
    ...
    {RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS, RilParser::CreateSystemSelectionChannels},
    {RIL_REQUEST_ENABLE_NR_DUAL_CONNECTIVITY, RilParser::CreateInt},
    {RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP, RilParser::CreateInt},
    {RIL_REQUEST_ENABLE_VONR, RilParser::CreateInt},
    {RIL_REQUEST_SET_USAGE_SETTING, RilParser::CreateInt},
    ...
    {RIL_REQUEST_SET_SUPP_SVC_NOTIFICATION, RilParser::CreateInt},
    ...
    {RIL_REQUEST_NV_RESET_CONFIG, RilParser::CreateInt},
    ...
    {RIL_REQUEST_SET_DATA_THROTTLING, RilParser::CreateDataThrottling},

    // SIM PhoneBook
    {RIL_REQUEST_UPDATE_SIM_PHONEBOOK_RECORDS, RilParser::CreateUpdatePbEntry},
    ...
    {RIL_REQUEST_OEM_SET_PLMN_LIST, RilParser::CreateRawData},
    ...
    {RIL_REQUEST_SET_NR_MODE, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_NR_SILENCE_MODE, RilParser::CreateInts},

    // PS
    {RIL_REQUEST_RELEASE_PDU_SESSION_ID, RilParser::CreateInt},
    {RIL_REQUEST_START_HANDOVER, RilParser::CreateInt},
    {RIL_REQUEST_CANCEL_HANDOVER, RilParser::CreateInt},
    ...
    {RIL_REQUEST_OEM_SET_PS_ATTACH_DETACH, RilParser::CreateInt},
    ...
    {RIL_REQUEST_OEM_SET_VOICE_OPERATION, RilParser::CreateInt},
    ...
    {RIL_REQUEST_OEM_DETACH, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_AP_SYSTEM_TIME, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_NR_MODE, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_VONR_CAPA, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_IMS_REGISTRATION_STATE, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_MOBILE_DATA_STATE, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SEND_TEST_JSON_DATA, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_INTERNAL_IA, RilParser::CreateString},
    {RIL_REQUEST_OEM_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA, RilParser::CreateOemSignalStrengthReportingCriteria},
    ...
    {RIL_REQUEST_OEM_AIMS_AT_CMD_FORWARDING, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_CALL_TRANSFER, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_COMMON_IMS_SVC_INFO, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_COMPOSER_MMTEL, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_ENRICHED_CALLING, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_CANCEL_COMPOSER_MMTEL, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_SET_RTP_HEADER_EXTENSION_TYPE, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_SEND_RTP_HEADER_EXTENSION, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_SEND_UL_SIP_MSG_IND, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_DL_SIP_MSG_RESULT_IND, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_REGISTER_IND, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_SET_TEMP_EMERGENCY_NUMBER, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_DC_SESSION_UPDATE, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_DC_SESSION_MANAGE, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_DC_SESSION_MODIFY_IND, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_AIMS_EMERGENCY_VOWIFI_CAPABILITY, RilParser::CreateRawData},
    //AIMS support end ---------------------

    {RIL_REQUEST_OEM_IMS_SIP_MESSAGE, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_UPDATE_REGISTRATION_INFO, RilParser::CreateUpdateImsRegistrationInfo},
    {RIL_REQUEST_OEM_IMS_START_IMS_TRAFFIC, RilParser::CreateStartImsTraffic},
    {RIL_REQUEST_OEM_IMS_STOP_IMS_TRAFFIC, RilParser::CreateInt},
    {RIL_REQUEST_OEM_IMS_TRIGGER_EPS_FALLBACK, RilParser::CreateTriggerEpsFallback},
    {RIL_REQUEST_OEM_IMS_SET_SRVCC_CALL_INFO, RilParser::OemCreateSrvccCallInfo},
    {RIL_REQUEST_OEM_IMS_MT_CALL_GUARDTMR_STATUS_IND, RilParser::CreateRawData},
    ...
    /* Call Deflection */
    {RIL_REQUEST_OEM_AIMS_CALL_DEFLECTION_REQ, RilParser::CreateRawData},
    ...
    { RIL_REQUEST_OEM_GPS_SET_GNSS_BLANKING, RilParser::CreateRawData},
    ...
    { RIL_REQUEST_OEM_GPS_SET_GNSS_BLANKING_TDL, RilParser::CreateRawData},
    ...
    /* BIP Channel Manager */
    { RIL_REQUEST_OEM_WIFI_STATUS_RESPONSE, RilParser::CreateRawData },
    { RIL_REQUEST_OEM_WIFI_CHANNEL_STATUS_REPORT, RilParser::CreateRawData },
    { RIL_REQUEST_OEM_WIFI_OPEN_CHANNEL_RESPONSE, RilParser::CreateRawData },
    { RIL_REQUEST_OEM_WIFI_SEND_DATA_RESPONSE, RilParser::CreateRawData },
    { RIL_REQUEST_OEM_WIFI_RECEIVE_DATA_RESPONSE, RilParser::CreateRawData },
    { RIL_REQUEST_OEM_WIFI_CLOSE_CHANNEL_RESPONSE, RilParser::CreateRawData },
    ...
    {RIL_REQUEST_OEM_GET_MODEM_ACTIVITY_INFO, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_SELFLOG_PROFILE, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_FORBID_LTE_CELL, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_SVN, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_FORBID_FREQUENCY, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_FORBID_LTE_BAND, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_FORBID_LTE_TAC, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_SELFLOG_TCP_DUMP_MODE, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_BSR_PARA, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_AHEAD_RRE, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_DRDV, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_FORBID_NR_CELL, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_SRS_PWR_LIMIT, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_TRACE_DUMP_CFG, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_SET_UE_OPERATION_MODE, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_NRRRM_MIN_REQ_ENABLE, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_PWR_DETECT_THR, RilParser::CreateInts},
    {RIL_REQUEST_OEM_SET_VCRT, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_ENABLE_N28, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_UL_MIMO, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_BTL_BUFMAX_SIZE, RilParser::CreateInt},
    {RIL_REQUEST_OEM_SET_NR_DISABLE_BAND, RilParser::CreateRawData},

    {RIL_REQUEST_OEM_MISC_SET_TELEPHONY_STATUS_LOGGING, RilParser::CreateInts},
    {RIL_REQUEST_OEN_MISC_TEST_UNSOL, RilParser::CreateRawData},
    ...
    // Call Barring
    {RIL_REQUEST_OEM_CHANGE_BARRING_PASSWORD_OVER_MMI, RilParser::OemCreateStrings},
    ...
    {RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE, RilParser::CreateCdmaSms},
    ...
    // SAP
    {RIL_REQUEST_SIM_SAP_CONNECT, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_DISCONNECT, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_APDU, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_TRANSFER_ATR, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_POWER, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_RESET_SIM, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_TRANSFER_CARD_READER_STATUS, RilParser::CreateRawData},
    {RIL_REQUEST_SIM_SAP_SET_TRANSFER_PROTOCOL, RilParser::CreateRawData},

    {RIL_REQUEST_OEM_SET_URSP, RilParser::CreateSetUrspData},
    {RIL_REQUEST_OEM_SET_EMC_LAB_TEST_MODE, RilParser::CreateInt},
    {RIL_REQUEST_OEM_UPDATE_EMERGENCY_NUMBER_LIST, RilParser::CreateRawData},

    {RIL_REQUEST_OEM_SET_CP_CARRIER_CONFIG, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_RRC_INFO, RilParser::CreateInt},

    // IMS MEDIA
    {RIL_REQUEST_OEM_IMS_TEST_RCM, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_INIT, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_OPEN_SESSION, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_CLOSE_SESSION, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_MODIFY_SESSION, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_SEND_DTMF, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_START_DTMF, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_STOP_DTMF, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_SEND_TEXT, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_SEND_HEADER_EXTENSION, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_SET_MEDIA_QUALITY_THRESHOLD,RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_GET_OPERATION_MODE, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_WIFI_CONFIG, RilParser::CreateRawData},
    {RIL_REQUEST_OEM_IMS_MEDIA_QUERY_MAC_CE_INFO, RilParser::CreateRawData},
};
...
{
    RequestData *pData = new DtmfInfo(id, tok, data ? data[0] : 0);
    if(NULL == pData)
    {
        RilLogE("[%s] No enough memory", TAG);
        return NULL;
...
RequestData *RilParser::CreateSystemSelectionChannels(int id, Token tok, char *data, unsigned int datalen)
{
    RequestData *pData = new SystemSelectionChannelsReqData(id, tok);
...
RequestData *RilParser::CreateOemSignalStrengthReportingCriteria(int id, Token tok, char *data, unsigned int datalen)
{
    RequestData *pData = new SignalStrengthReportingCriteria_V2_0(id, tok);
    if (pData->encode(data, datalen) < 0) {
        delete pData;
        return NULL;
    }
...
RequestData *RilParser::CreateSetUrspData(int id, Token tok, char *data, unsigned int datalen)
{
    RequestData *pData = new SetUrspRequestData(id, tok);
    ...
    RilLogE("datalen : %d (Ursp %d) ", datalen, sizeof(UrspData));
    if (pData->encode(data, datalen) < 0) {
        delete pData;
        return NULL;
    }
...
RequestData *RilParser::CreateDataThrottling(int id, Token tok, char *data, unsigned int datalen)
{
    RequestData *pData = new DataThrottlingReqData(id, tok);
...
RequestData *RilParser::CreateSlotPortMapping(int id, Token tok, char *data, unsigned int datalen)
{
    RequestData *pData = new SlotPortMapping(id, tok);
...
RequestData *RilParser::OemCreateStrings(int id, Token tok, char *data, unsigned int datalen) {
    RequestData *pData = new OemStringsRequestData(id, tok);
    if (NULL == pData) {
        RilLogE("[%s] No enough memory", TAG);
        return NULL;
    }
...
RequestData *RilParser::CreateUpdateImsRegistrationInfo(int id, Token tok, char *data, unsigned int datalen) {
    RequestData *pData = new UpdateImsRegistrationInfoData(id, tok);
...
RequestData *RilParser::CreateStartImsTraffic(int id, Token tok, char *data, unsigned int datalen) {
    RequestData *pData = new StartImsTrafficData(id, tok);
...
RequestData *RilParser::CreateTriggerEpsFallback(int id, Token tok, char *data, unsigned int datalen) {
    RequestData *pData = new CreateTriggerEpsFallbackData(id, tok);
...
RequestData *RilParser::CreateSrvccCallInfo(int id, Token tok, char *data, unsigned int datalen) {
    RequestData *pData = new SrvccCallInfoData(id, tok);
...
RequestData *RilParser::OemCreateSrvccCallInfo(int id, Token tok, char *data, unsigned int datalen) {
    RequestData *pData = new OemSrvccCallInfoData(id, tok);
