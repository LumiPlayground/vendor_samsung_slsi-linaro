...
Message *Message::Clone() const
{
    ...
    if (msg != NULL) {
        ...
        msg->mTimestamp = this->mTimestamp;
    }
...
Message &Message::operator=(const Message &rhs)
{
    ...
    this->mTimestamp = rhs.mTimestamp;
...
{
    auto message = Message::NewInstance(nTargetServiceId, nTargetMessageId, RESPONSE, NULL, pModemData);
    if (message) {
        message->mTimestamp = OsalUtils::elapsedRealtime();
    }
    return message;
}
