...
//#define MSG_XXX_BASE       10000    // for future usage
#define MSG_VSIM_BASE       11000
//#define MSG_XXX_BASE      12000     // for future usage
#define MSG_STK_BASE        13000
#define MSG_EMBMS_BASE      14000
#define MSG_SAP_BASE        15000
...
enum CscServiceMsgId {
    MSG_CS_CALL_LIST    = MSG_CS_BASE + 1,  //1001
    ...
    MSG_CS_CALL_ANSWER,
    MSG_CS_CALL_ANSWER_DONE,

    MSG_CS_SS_EXPLICIT_CALL_TRANSFER,   //1011
    ...
    MSG_CS_SS_SWITCH_WAITING_OR_HOLDING_AND_ACTIVE_DONE,

    MSG_CS_SS_CONFERENCE,   //1031
    ...
    MSG_CS_SS_QUERY_CALL_BARRING,

    MSG_CS_SS_CALL_BARRING_DONE,    //1041
    ...
    MSG_CS_SOUND_CLOCK_CTRL_NTF,

    MSG_CS_SOUND_MIC_CONTROL,   //1061
    ...
    MSG_CS_IND_EMERGENCY_SUPPORT_RAT_MODE, //1071
...
enum SupplementaryServiceMsgId {
    MSG_SS_GET_CLIP    = MSG_SS_BASE + 1,   //1501
    ...
    MSG_SS_SET_CALL_WAITING_DONE,   //1511
...
enum SimServiceMsgId {
    MSG_SIM_GET_STATUS = MSG_SIM_BASE + 1,  //2001
    ...
    MSG_SIM_SET_FACILITY_LOCK,  //2021
    ...
    MSG_SIM_GET_ATR,
    MSG_SIM_GET_ATR_DONE,   // 2041

    MSG_SIM_SET_UICC,
    MSG_SIM_SET_UICC_DONE,

    //PhoneBook
    MSG_SIM_READ_PB_ENTRY,  // 2044
    MSG_SIM_READ_PB_ENTRY_DONE,
    MSG_SIM_UPDATE_PB_ENTRY,
    MSG_SIM_UPDATE_PB_ENTRY_DONE,
    MSG_SIM_READ_PB_CAPA,
    MSG_SIM_READ_PB_CAPA_DONE,
    MSG_SIM_GET_PB_STORAGE_INFO,
    MSG_SIM_GET_PB_STORAGE_INFO_DONE,
    MSG_SIM_GET_3G_PB_CAPA,
    MSG_SIM_GET_3G_PB_CAPA_DONE,
    MSG_SIM_GET_PHONEBOOK_RECORDS,
    MSG_SIM_GET_PHONEBOOK_CAPACITY,
    MSG_SIM_PB_READY,

    MSG_SIM_OEM_IMS_SIM_IO,  // 2057
    ...
    MSG_SIM_OEM_SE_RESET,   // 2071
    MSG_SIM_OEM_SE_RESET_DONE,


    // New definition
    // Please define new message IDs of SMI(SIT) before HERE!
    MSG_SIM_GET_ICCID = 2900,
    MSG_SIM_GET_ICCID_DONE, //2901
    ...
    MSG_SIM_GET_SIM_APPLICATION,    // 2911
    ...
    MSG_SIM_GET_SIM_LOCK_INFO_DONE, //2921
    MSG_SIM_ENABLE_UICC_APP,
    MSG_SIM_GET_UICC_APP_ENABLEMENT,
    MSG_SIM_AUTO_DISABLE_UICC_APP_DONE,
    MSG_SIM_DEPERSONALIZATION,
    MSG_SIM_DEPERSONALIZATION_DONE,
    MSG_IND_SIM_TRAY_STATUS,  //2926

    // Auto verify PIN
    MSG_SIM_IND_ENCRYPTED_PIN,
...
enum NetworkServiceMsgId {
    MSG_NET_VOICE_REGISTRATION_STATE = MSG_NET_BASE + 1,    //4001
    ...
    MSG_NET_QUERY_BPLMN_SEARCH_DONE,    //4021
    ...
    MSG_NET_SET_PREF_NETWORK_TYPE_DONE, //4031
    ...
    MSG_NET_ALLOW_DATA_DONE,    //4041
    MSG_NET_SHUTDOWN,
    MSG_NET_SHUTDOWN_DONE,
    MSG_NET_SET_UPLMN,         // deprecated
    MSG_NET_SET_UPLMN_DONE,    // deprecated
    MSG_NET_GET_UPLMN,         // deprecated
    MSG_NET_GET_UPLMN_DONE,    // deprecated
    MSG_NET_SET_DS_NTW_TYPE,
    MSG_NET_SET_DS_NTW_TYPE_DONE,
    MSG_NET_GET_RC_NTW_TYPE,

    MSG_NET_GET_RC_NTW_TYPE_DONE,   //4051
    ...
    MSG_NET_NETWORK_STATE_CHANGED,  //4061
    ...
    MSG_NET_OEM_GET_IMS_SUPPORT_SERVICE,    //4071
    ...
    MSG_NET_IDENTITY_RECEIVED,  //4081
    ...
    MSG_NET_IND_NETWORK_SCAN_RESULT, //4091
    ...
    MSG_NET_OEM_SET_ENDC_MODE_DONE,  //4101
    ...
    MSG_NET_SET_SYSTEM_SELECTION_CHANNELS_DONE,  //4111
    MSG_NET_GET_BARRING_INFO,
    MSG_NET_GET_BARRING_INFO_DONE,
    MSG_NET_IND_BARRING_INFO,
    MSG_NET_IND_REG_FAILED,
    MSG_NET_SET_NR_MODE,
    MSG_NET_SET_NR_MODE_DONE,
    MSG_NET_GET_NR_MODE,
    MSG_NET_GET_NR_MODE_DONE,

    MSG_NET_SET_NR_SILENCE_MODE,  // 4121
    MSG_NET_GET_NR_SILENCE_MODE,
    MSG_NET_SET_VONR_CAPA,
    MSG_NET_GET_VONR_CAPA,
    ...
    MSG_NET_SET_VONR_ENABLED,
    MSG_NET_GET_VONR_ENABLED,
    MSG_NET_SET_MOBILE_DATA_STATE,
    MSG_NET_SET_USAGE_SETTING,
    MSG_NET_GET_USAGE_SETTING,
    MSG_NET_IND_DSDS_STATUS,
};
 ...
 */
enum PsServiceMsgId {
    MSG_PS_SETUP_DATA_CALL = MSG_PS_BASE + 1,   //3001
    ...
    MSG_PS_REFRESH_INITIAL_ATTACH_APN,  //3011
    ...
    MSG_PS_SET_DATA_PROFILE_INITIAL_ATTACH, //3021
    ...
    MSG_PS_IND_UNTHROTTLE_APN,  // 3031
    MSG_PS_ALLOC_PDU_SESSION,
    MSG_PS_REL_PDU_SESSION,
    MSG_PS_START_HANDOVER,
    MSG_PS_CANCEL_HANDOVER,

    MSG_PS_SLICING_CONFIG,
    MSG_PS_SLICING_CONFIG_DONE,

    MSG_IND_PS_DATA_OFF_STATUS,
    ...
    /* NR SA SSC MODE */
    MSG_PS_SET_PDN_IP_ADDRESS,
    MSG_PS_IND_ADDR_STATUS,
    MSG_PS_OEM_SET_URSP,
    MSG_PS_OEM_SET_URSP_DONE,

    MSG_PS_SLICING_CONFIG_UPDATED, // OEM
    MSG_PS_RRC_INFO,
};
...
enum MiscServiceMsgId {
    MSG_MISC_BASEBAND_VER = MSG_MISC_BASE + 1,  //5001
    ...
    MSG_MISC_SEND_DEVICE_STATE, //5011
    MSG_MISC_GET_IMEI,
    ...
    MSG_MISC_NV_WRITE_ITEM_DONE,    //5021
    ...
    MSG_MISC_UNSOL_OEM_DISPLAY_ENG, //5031
    ...
    MSG_MISC_OEM_APN_SETTINGS,  //5041
    ...
    MSG_MISC_OEM_GET_RF_DESENSE_MODE_DONE,  //5051
    ...
    MSG_MISC_OEM_GET_PREFERRED_CALL_CAPABILITY_DONE,    //5061
    ...
    MSG_MISC_OEM_FCRASH_MNR_REQ,    //5081
    ...
    MSG_MISC_OEM_NOTIFY_CPCRASH,    //5091
    ...
    MSG_MISC_GET_VOICE_OPERATION,
    MSG_MISC_GET_VOICE_OPERATION_DONE,
    MSG_MISC_SET_INDICATION_FILTER,
    MSG_MISC_SET_INDICATION_FILTER_DONE,

    MSG_MISC_GET_NEIGHBORING_CELL_IDS,  //5101
    ...
    MSG_MISC_OEM_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA,
    MSG_MISC_SET_LINK_CAPACITY_REPORTING_CRITERIA,
    MSG_MISC_NV_RESET_CONFIG,

    MSG_MISC_SET_LINK_CAPACITY_REPORTING_CRITERIA_DONE, //5111
    ...
    MSG_MISC_SET_SAR_STATE_DONE,    //5121
    ...
    MSG_MISC_GET_PLMN_NAME_FROM_SE13TABLE,  //5131
    ...
    MSG_MISC_OEM_SET_PROVISION_UPDATE_DONE_REQUEST_DONE,    //5141
    ...
    MSG_MISC_ENABLE_MODEM_DONE, //5151
    ...
    MSG_MISC_OEM_SET_PDCP_DISCARD_TIMER,    //5171
    ...
    MSG_MISC_OEM_SET_TCS_FCI_REQ,   //5181
    ...
    MSG_MISC_OEM_SET_ELEVATOR_SENSOR_DONE,  //5191
    ...
    MSG_MISC_GET_CDMA_SUBSCRIPTION_DONE, // 5201
    ...
    MSG_MISC_SET_AP_SYSTEM_TIME_DONE,
    MSG_MISC_SET_DATA_THROTTLING,
    MSG_MISC_OEM_IND_BASESTATION_INFO,
    MSG_MISC_OEM_GET_MODEM_ACTIVITY_INFO,
    MSG_MISC_OEM_GET_MODEM_ACTIVITY_INFO_DONE, // 5211
    MSG_MISC_OEM_SET_SVN,
    MSG_MISC_OEM_SET_SVN_DONE,
    MSG_MISC_SET_FEATURE_INFO,
    MSG_MISC_SET_FEATURE_INFO_DONE,
    MSG_MISC_OEM_IND_DROPPED_MT_CALL_INFO,

    MSG_MISC_OEM_SET_FORBID_FREQUENCY,
    MSG_MISC_OEM_SET_FORBID_FREQUENCY_DONE,
    MSG_MISC_OEM_SET_FORBID_LTE_BAND,
    MSG_MISC_OEM_SET_FORBID_LTE_BAND_DONE,  // 5221
    MSG_MISC_OEM_SET_FORBID_LTE_TAC,
    MSG_MISC_OEM_SET_FORBID_LTE_TAC_DONE,
    MSG_MISC_OEM_SET_SELFLOG_TCP_DUMP_MODE,
    MSG_MISC_OEM_SET_SELFLOG_TCP_DUMP_MODE_DONE,
    MSG_MISC_OEM_SET_ALL_DIV_SETTING,
    MSG_MISC_OEM_SET_ALL_DIV_SETTING_DONE,

    MSG_MISC_OEM_SET_BSR_PARA,
    MSG_MISC_OEM_SET_BSR_PARA_DONE,
    MSG_MISC_OEM_SET_AHEAD_RRE,
    MSG_MISC_OEM_SET_AHEAD_RRE_DONE, // 5231
    MSG_MISC_OEM_SET_DRDV,
    MSG_MISC_OEM_SET_DRDV_DONE,
    MSG_MISC_OEM_SET_EMC_LAB_TEST_MODE,
    MSG_MISC_OEM_SET_EMC_LAB_TEST_MODE_DONE,
    MSG_MISC_OEM_SET_FORBID_NR_CELL,
    MSG_MISC_OEM_SET_FORBID_NR_CELL_DONE,
    MSG_MISC_OEM_GET_CDMA_CAPABILITY_INFO,
    MSG_MISC_GET_BINARY_VERSION_INFO,
    MSG_MISC_OEM_SET_TELEPHONY_STATUS_LOGGING,
    MSG_MISC_OEM_TEST_UNSOL,    // 5241
    MSG_MISC_OEM_UPDATE_EMERGENCY_NUMBER_LIST,
    MSG_MISC_OEM_SEND_TEST_JSON_DATA,
    MSG_MISC_SET_CP_CARRIER_CONFIG,
    MSG_MISC_CARRIER_CONFIG_STATUS_IND,
    MSG_MISC_CARRIER_CONFIG_SIM_INFO_IND,
    MSG_MISC_OEM_SET_SRS_PWR_LIMIT,
    MSG_MISC_OEM_SET_TRACE_DUMP_CFG,
    MSG_MISC_OEM_GET_TRACE_DUMP_CFG,
    MSG_MISC_OEM_SET_UE_OPERATION_MODE,
    MSG_MISC_OEM_GET_UE_OPERATION_MODE,
    MSG_MISC_OEM_SET_NRRRM_MIN_REQ_ENABLE,
    MSG_MISC_OEM_GET_NRRRM_MIN_REQ_ENABLE,
    MSG_MISC_OEM_SET_PWR_DETECT_THR,
    MSG_MISC_OEM_SET_VCRT,
    MSG_MISC_OEM_SET_ENABLE_N28,
    MSG_MISC_SET_UL_MIMO,
    MSG_MISC_OEM_SET_BTL_BUFMAX_SIZE,
    MSG_MISC_OEM_GET_VCRT,
    MSG_MISC_SET_NR_DISABLE_BAND,
};
...
enum CSmsServiceMsgId {
    MSG_SMS_SEND = MSG_SMS_BASE + 1,    //6001
    MSG_SMS_SEND_MORE,
    MSG_SMS_SEND_DONE,
    MSG_SMS_ACKNOWLEDGE,
    ...
    MSG_SMS_GET_BROADCAST_SMS_CONFIG_DONE,  //6011
    ...
    MSG_SMS_REPORT_SMS_MEMORY_STATUS_DONE,  //6021
    ...
    MSG_SMS_AIMS_SEND_EXPECT_MORE,  //6031
...
enum CAudioServiceMsgId {
    MSG_AUDIO_SET_VOLUME = MSG_AUDIO_BASE + 1,  //7001
    ...
    MSG_AUDIO_WB_AMR_SET_CAPABILITY_DONE,   //7021
...
enum CImsServiceMsgId {
    ...
    MSG_AIMS_AT_CMD_FORWARDING_DONE,
    MSG_AIMS_CALL_TRANSFER,
    MSG_AIMS_CALL_TRANSFER_DONE,
    MSG_AIMS_COMMON_IMS_SVC_INFO,

    MSG_AIMS_COMMON_IMS_SVC_INFO_DONE,
    MSG_AIMS_COMPOSER_MMTEL_REQ,
    MSG_AIMS_COMPOSER_MMTEL_REQ_DONE,
    ...
    MSG_AIMS_ENRICHED_CALLING_DONE,
    MSG_AIMS_CANCEL_COMPOSER_MMTEL,
    MSG_AIMS_CANCEL_COMPOSER_MMTEL_DONE,
    MSG_AIMS_CALL_DEFLECTION_REQ,
    MSG_AIMS_CALL_DEFLECTION_REQ_DONE,
    MSG_AIMS_SET_RTP_HEADER_EXTENSION_TYPE,
    MSG_AIMS_SET_RTP_HEADER_EXTENSION_TYPE_DONE,
    MSG_IND_AIMS_RTP_HEADER_EXTENSION_TYPE,
    MSG_AIMS_SEND_RTP_HEADER_EXTENSION,
    MSG_AIMS_SEND_RTP_HEADER_EXTENSION_DONE,
    ...
    MSG_AIMS_SET_TEMP_EMERGENCY_NUMBER,
...
//AIMS support end ---------------------
    ...
    MSG_IMS_UNSOL_TRIGGER_IMS_DEREGISTRATION,
    MSG_IMS_START_IMS_TRAFFIC,
    MSG_IMS_STOP_IMS_TRAFFIC,
    MSG_IMS_UNSOL_CONNECTION_SETUP_FAILURE,
    MSG_IMS_TRIGGER_EPS_FALLBACK,
    MSG_IMS_IND_TRIGGER_EPS_FALLBACK,
    ...
    MSG_IMS_SET_SRVCC_CALL_INFO,
    MSG_IMS_MEDIA_QUERY_MAC_CE_INFO,
    MSG_IMS_MEDIA_IND_MAC_CE_INFO,
    MSG_IMS_MT_CALL_GUARDTMR_STATUS_IND,
    MSG_IMS_IND_MT_CSFB,
};
...
enum GpsServiceMsgId {
    MSG_GPS_SET_FREQUENCY_AIDING = MSG_GPS_BASE + 1,    //9001
    ...
    MSG_GPS_SET_SUPL_NI_READY ,             // From AP, To AP   //9011
    ...
    MSG_GPS_IND_LPP_REQUEST_ASSIST_DATA,    //9021
    ...
    MSG_GPS_CONTROL_PLANE_ENABLE_DONE,  //9031
    ...
    MSG_GPS_SET_GPS_LOCK_MODE_DONE, //9041
    ...
    MSG_GPS_IND_CDMA_SEND_ACQUSITION_ASSIT_DATA,    //9051
    ...
    MSG_GPS_SET_GNSS_BLANKING,
    MSG_GPS_SET_GNSS_BLANKING_DONE,
    MSG_GPS_SET_GNSS_BLANKING_TDL,
    MSG_GPS_GET_SIM_STATE,
    MSG_GPS_GET_NETWORK_TYPE,
    MSG_GPS_IS_CAMPING_ON_LTE,

    MSG_GPS_INTERNAL_UPDATE_DEVICE_INFO,
};

/**
 * XXXService  (base 10000) for future usage
 */
...
enum VsimServiceMsgId {
    MSG_VSIM_NOTIFICATION = MSG_VSIM_BASE + 1,  //11001
...
/**
 * XXXService (base 12000) for future usage
 */
...
enum StkServiceMsgId {
    MSG_SAT_STK_IS_RUNNING = MSG_STK_BASE + 1,  //13001
    ...
    MSG_SAT_STK_HANDLE_CALL_SETUP_REQ_FROM_SIM_DONE,    //13011
 ...
 * SapService
 */
enum SapServiceMsgId {
    MSG_SAP_CONNECT = MSG_SAP_BASE + 1,
    MSG_SAP_CONNECT_DONE,
    MSG_SAP_DISCONNECT,
    MSG_SAP_DISCONNECT_DONE,
    MSG_SAP_APDU,
    MSG_SAP_APDU_DONE,
    MSG_SAP_TRANSFER_ATR,
    MSG_SAP_TRANSFER_ATR_DONE,
    MSG_SAP_POWER,
    MSG_SAP_POWER_DONE,
    MSG_SAP_RESET_SIM,
    MSG_SAP_RESET_SIM_DONE,
    MSG_SAP_TRANSFER_CARD_READER_STATUS,
    MSG_SAP_TRANSFER_CARD_READER_STATUS_DONE,
    MSG_SAP_SET_TRANSFER_PROTOCOL,
    MSG_SAP_SET_TRANSFER_PROTOCOL_DONE,
    MSG_SAP_DISCONNECT_IND,
    MSG_SAP_STATUS_IND,
    MSG_SAP_ERROR_RESP_IND,
};
