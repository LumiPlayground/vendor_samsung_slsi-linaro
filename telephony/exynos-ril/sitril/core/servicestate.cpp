...
ServiceState& ServiceState::operator=(const ServiceState& rhs)
{
    ...
    this->mOperatorNumericRaw = rhs.mOperatorNumericRaw;
    this->mOperatorAlphaLongRaw = rhs.mOperatorAlphaLongRaw;
    this->mOperatorAlphaShortRaw = rhs.mOperatorAlphaShortRaw;
...
bool ServiceState::operator==(const ServiceState& rhs) const
{
...
string ServiceState::toString() const
{
    stringstream ss;
    ss << "{";
    ss << "mVoiceRegState=";
    ...
    ss << mOperatorAlphaShort;
    ss << ",mOperatorNumericRaw=";
    ss << mOperatorNumericRaw;
    ss << ",mOperatorAlphaLongRaw=";
    ss << mOperatorAlphaLongRaw;
    ss << ",mOperatorAlphaShort=Raw";
    ss << mOperatorAlphaShortRaw;
...
void ServiceState::setOperatorNameRaw(const string& longNameRaw, const string& shortNameRaw)
{
    this->mOperatorAlphaLongRaw = longNameRaw;
    this->mOperatorAlphaShortRaw = shortNameRaw;
}
...
bool ServiceState::isVoiceOos() const
{
    switch(mVoiceRegState) {
    case RIL_NOT_REG_AND_NOT_SEARCHING:
    case RIL_NOT_REG_AND_SEARCHING:
    case RIL_UNKNOWN:
    case RIL_NOT_REG_AND_EMERGENCY_AVAILABLE_AND_NOT_SEARCHING:
...
bool ServiceState::isDataOos() const
{
