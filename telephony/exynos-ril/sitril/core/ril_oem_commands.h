...
RouteMap s_RilOemRequestServiceMap = {
    ...
    { RIL_REQUEST_OEM_SET_VOICE_OPERATION, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_VOICE_OPERATION) },
    { RIL_REQUEST_OEM_GET_VOICE_OPERATION, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_GET_VOICE_OPERATION) },
    { RIL_REQUEST_OEM_SET_FEATURE_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_FEATURE_INFO) },
    { RIL_REQUEST_OEM_SEND_TEST_JSON_DATA, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SEND_TEST_JSON_DATA) },
    ...
    { RIL_REQUEST_OEM_DETACH, std::make_pair(RIL_SERVICE_PS, MSG_PS_DETACH) },
    ...
    { RIL_REQUEST_OEM_IMS_SIM_IO, std::make_pair(RIL_SERVICE_SIM_IO, MSG_SIM_OEM_IMS_SIM_IO ) },
    ...
    { RIL_REQUEST_OEM_SET_NR_MODE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_NR_MODE) },
    { RIL_REQUEST_OEM_GET_NR_MODE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_NR_MODE) },
    { RIL_REQUEST_OEM_SET_NR_SILENCE_MODE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_NR_SILENCE_MODE) },
    { RIL_REQUEST_OEM_GET_NR_SILENCE_MODE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_NR_SILENCE_MODE) },
    { RIL_REQUEST_OEM_SET_VONR_CAPA, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_VONR_ENABLED) },
    { RIL_REQUEST_OEM_GET_VONR_CAPA, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_VONR_ENABLED) },
    { RIL_REQUEST_OEM_SET_PLMN_LIST, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_PLMN_LIST) },
    { RIL_REQUEST_OEM_GET_PLMN_LIST, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_PLMN_LIST) },
    { RIL_REQUEST_OEM_SET_IMS_REGISTRATION_STATE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_IMS_REGISTRATION_STATE) },
    { RIL_REQUEST_OEM_SET_MOBILE_DATA_STATE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_MOBILE_DATA_STATE) },
    { RIL_REQUEST_OEM_GET_NITZ_TIME, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_GET_NITZ_TIME) },
    { RIL_REQUEST_OEM_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_SIGNAL_STRENGTH_REPORTING_CRITERIA) },
    ...
    { RIL_REQUEST_OEM_GPS_SET_GNSS_BLANKING, std::make_pair(RIL_SERVICE_GPS, MSG_GPS_SET_GNSS_BLANKING ) },
    ...
    { RIL_REQUEST_OEM_GPS_SET_GNSS_BLANKING_TDL, std::make_pair(RIL_SERVICE_GPS, MSG_GPS_SET_GNSS_BLANKING_TDL ) },
    { RIL_REQUEST_OEM_GPS_GET_SIM_STATE, std::make_pair(RIL_SERVICE_GPS, MSG_GPS_GET_SIM_STATE ) },
    { RIL_REQUEST_OEM_GPS_GET_NETWORK_TYPE, std::make_pair(RIL_SERVICE_GPS, MSG_GPS_GET_NETWORK_TYPE ) },
    { RIL_REQUEST_OEM_IS_CAMPING_ON_LTE, std::make_pair(RIL_SERVICE_GPS, MSG_GPS_IS_CAMPING_ON_LTE ) },
    // Indication from CP
    ...
    { RIL_REQUEST_OEM_AIMS_AT_CMD_FORWARDING, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_AT_CMD_FORWARDING ) },
    { RIL_REQUEST_OEM_AIMS_CALL_TRANSFER, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_CALL_TRANSFER ) },
    { RIL_UNSOL_OEM_AIMS_MEDIA_STATUS, std::make_pair(RIL_SERVICE_IMS, MSG_IND_AIMS_MEDIA_STATUS ) },
    { RIL_REQUEST_OEM_AIMS_COMMON_IMS_SVC_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_COMMON_IMS_SVC_INFO ) },
    { RIL_REQUEST_OEM_AIMS_COMPOSER_MMTEL, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_COMPOSER_MMTEL_REQ) },
    { RIL_REQUEST_OEM_AIMS_ENRICHED_CALLING, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_ENRICHED_CALLING) },
    { RIL_REQUEST_OEM_AIMS_CANCEL_COMPOSER_MMTEL, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_CANCEL_COMPOSER_MMTEL ) },
    //Call Deflection
    { RIL_REQUEST_OEM_AIMS_CALL_DEFLECTION_REQ, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_CALL_DEFLECTION_REQ ) },
    { RIL_REQUEST_OEM_AIMS_SET_RTP_HEADER_EXTENSION_TYPE, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_SET_RTP_HEADER_EXTENSION_TYPE ) },
    { RIL_REQUEST_OEM_AIMS_SEND_RTP_HEADER_EXTENSION, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_SEND_RTP_HEADER_EXTENSION ) },
    { RIL_REQUEST_OEM_AIMS_SEND_UL_SIP_MSG_IND, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_SEND_UL_SIP_MSG_IND ) },
    { RIL_REQUEST_OEM_AIMS_DL_SIP_MSG_RESULT_IND, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_DL_SIP_MSG_RESULT_IND ) },
    { RIL_REQUEST_OEM_AIMS_REGISTER_IND, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_REGISTER_IND ) },
    { RIL_REQUEST_OEM_AIMS_SET_TEMP_EMERGENCY_NUMBER, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_SET_TEMP_EMERGENCY_NUMBER ) },
    { RIL_REQUEST_OEM_AIMS_EMERGENCY_VOWIFI_CAPABILITY, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_EMERGENCY_VOWIFI_CAPABILITY) },
    // DC
    {RIL_REQUEST_OEM_AIMS_DC_SESSION_UPDATE, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_DC_SESSION_UPDATE ) },
    {RIL_REQUEST_OEM_AIMS_DC_SESSION_MANAGE, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_DC_SESSION_MANAGE ) },
    {RIL_REQUEST_OEM_AIMS_DC_SESSION_MODIFY_IND, std::make_pair(RIL_SERVICE_IMS, MSG_AIMS_DC_SESSION_MODIFY_IND ) },
    //AIMS support end ---------------------

    { RIL_REQUEST_OEM_IMS_SIP_MESSAGE, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_SIP_MESSAGE) },
    { RIL_REQUEST_OEM_IMS_UPDATE_REGISTRATION_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_UPDATE_IMS_REGISTRATION_INFO) },
    { RIL_REQUEST_OEM_IMS_START_IMS_TRAFFIC, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_START_IMS_TRAFFIC) },
    { RIL_REQUEST_OEM_IMS_STOP_IMS_TRAFFIC, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_STOP_IMS_TRAFFIC) },
    { RIL_REQUEST_OEM_IMS_TRIGGER_EPS_FALLBACK, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_TRIGGER_EPS_FALLBACK) },
    { RIL_REQUEST_OEM_IMS_SET_SRVCC_CALL_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_SET_SRVCC_CALL_INFO) },
    { RIL_REQUEST_OEM_IMS_MT_CALL_GUARDTMR_STATUS_IND, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MT_CALL_GUARDTMR_STATUS_IND) },
    ...
    { RIL_REQUEST_OEM_SIM_RESET, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_OEM_SE_RESET) },
    ...
    /* BIP Channel Manager */
    { RIL_REQUEST_OEM_WIFI_STATUS_RESPONSE, std::make_pair(RIL_SERVICE_STK, MSG_SAT_WIFI_STATUS_RESPONSE) },
    { RIL_REQUEST_OEM_WIFI_CHANNEL_STATUS_REPORT, std::make_pair(RIL_SERVICE_STK, MSG_SAT_WIFI_CHANNEL_STATUS_REPORT) },
    { RIL_REQUEST_OEM_WIFI_OPEN_CHANNEL_RESPONSE, std::make_pair(RIL_SERVICE_STK, MSG_SAT_WIFI_OPEN_CHANNEL_RESPONSE) },
    { RIL_REQUEST_OEM_WIFI_SEND_DATA_RESPONSE, std::make_pair(RIL_SERVICE_STK, MSG_SAT_WIFI_SEND_DATA_RESPONSE) },
    { RIL_REQUEST_OEM_WIFI_RECEIVE_DATA_RESPONSE, std::make_pair(RIL_SERVICE_STK, MSG_SAT_WIFI_RECEIVE_DATA_RESPONSE) },
    { RIL_REQUEST_OEM_WIFI_CLOSE_CHANNEL_RESPONSE, std::make_pair(RIL_SERVICE_STK, MSG_SAT_WIFI_CLOSE_CHANNEL_RESPONSE) },
    ...
    { RIL_REQUEST_OEM_SET_UICC_SUBSCRIPTION, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_SET_UICC ) },
    ...
    { RIL_REQUEST_OEM_SET_AP_SYSTEM_TIME, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_AP_SYSTEM_TIME ) },
    { RIL_REQUEST_OEM_GET_MODEM_ACTIVITY_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_GET_MODEM_ACTIVITY_INFO ) },
    { RIL_REQUEST_OEM_SET_SVN, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_SVN ) },
    { RIL_REQUEST_OEM_SET_FORBID_FREQUENCY, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_FORBID_FREQUENCY ) },
    { RIL_REQUEST_OEM_SET_FORBID_LTE_BAND, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_FORBID_LTE_BAND ) },
    { RIL_REQUEST_OEM_SET_FORBID_LTE_TAC, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_FORBID_LTE_TAC ) },
    { RIL_REQUEST_OEM_SET_SELFLOG_TCP_DUMP_MODE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_SELFLOG_TCP_DUMP_MODE ) },
    { RIL_REQUEST_OEM_SET_ALL_DIV_SETTING, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_ALL_DIV_SETTING) },
    { RIL_REQUEST_OEM_SET_BSR_PARA, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_BSR_PARA) },
    { RIL_REQUEST_OEM_SET_AHEAD_RRE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_AHEAD_RRE ) },
    { RIL_REQUEST_OEM_SET_DRDV, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_DRDV) },
    { RIL_REQUEST_OEM_SET_EMC_LAB_TEST_MODE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_EMC_LAB_TEST_MODE) },
    { RIL_REQUEST_OEM_SET_FORBID_NR_CELL, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_FORBID_NR_CELL) },
    { RIL_REQUEST_OEM_GET_CDMA_CAPABILITY_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_GET_CDMA_CAPABILITY_INFO) },
    { RIL_REQUEST_OEM_UPDATE_EMERGENCY_NUMBER_LIST, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_UPDATE_EMERGENCY_NUMBER_LIST ) },
    { RIL_REQUEST_OEM_SET_SRS_PWR_LIMIT, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_SRS_PWR_LIMIT) },
    { RIL_REQUEST_OEM_SET_TRACE_DUMP_CFG, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_TRACE_DUMP_CFG) },
    { RIL_REQUEST_OEM_GET_TRACE_DUMP_CFG, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_GET_TRACE_DUMP_CFG) },
    { RIL_REQUEST_OEM_SET_UE_OPERATION_MODE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_UE_OPERATION_MODE) },
    { RIL_REQUEST_OEM_GET_UE_OPERATION_MODE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_GET_UE_OPERATION_MODE) },
    { RIL_REQUEST_OEM_SET_NRRRM_MIN_REQ_ENABLE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_NRRRM_MIN_REQ_ENABLE) },
    { RIL_REQUEST_OEM_GET_NRRRM_MIN_REQ_ENABLE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_GET_NRRRM_MIN_REQ_ENABLE) },
    { RIL_REQUEST_OEM_SET_PWR_DETECT_THR, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_PWR_DETECT_THR) },
    { RIL_REQUEST_OEM_SET_VCRT, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_VCRT) },
    { RIL_REQUEST_OEM_SET_ENABLE_N28, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_ENABLE_N28) },
    { RIL_REQUEST_OEM_SET_UL_MIMO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_UL_MIMO) },
    { RIL_REQUEST_OEM_GET_BINARY_VERSION_INFO, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_GET_BINARY_VERSION_INFO) },
    { RIL_REQUEST_OEM_SET_BTL_BUFMAX_SIZE, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_BTL_BUFMAX_SIZE ) },
    { RIL_REQUEST_OEM_GET_VCRT, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_GET_VCRT) },
    { RIL_REQUEST_OEM_SET_NR_DISABLE_BAND, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_NR_DISABLE_BAND) },

    // SAP
    { RIL_REQUEST_SIM_SAP_CONNECT, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_CONNECT) },
    { RIL_REQUEST_SIM_SAP_DISCONNECT, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_DISCONNECT) },
    { RIL_REQUEST_SIM_SAP_APDU, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_APDU) },
    { RIL_REQUEST_SIM_SAP_TRANSFER_ATR, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_TRANSFER_ATR) },
    { RIL_REQUEST_SIM_SAP_POWER, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_POWER) },
    { RIL_REQUEST_SIM_SAP_RESET_SIM, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_RESET_SIM) },
    { RIL_REQUEST_SIM_SAP_TRANSFER_CARD_READER_STATUS, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_TRANSFER_CARD_READER_STATUS) },
    { RIL_REQUEST_SIM_SAP_SET_TRANSFER_PROTOCOL, std::make_pair(RIL_SERVICE_SAP, MSG_SAP_SET_TRANSFER_PROTOCOL) },

    { RIL_REQUEST_OEM_SET_URSP, std::make_pair(RIL_SERVICE_PS, MSG_PS_OEM_SET_URSP) },

    { RIL_REQUEST_OEM_MISC_SET_TELEPHONY_STATUS_LOGGING, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_SET_TELEPHONY_STATUS_LOGGING) },
    { RIL_REQUEST_OEN_MISC_TEST_UNSOL, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_OEM_TEST_UNSOL) },
    { RIL_REQUEST_OEM_CHANGE_BARRING_PASSWORD_OVER_MMI, std::make_pair(RIL_SERVICE_SUPPLEMENTARY, MSG_SS_CALL_BARRING_PWD ) },

    { RIL_REQUEST_OEM_SET_CP_CARRIER_CONFIG, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_CP_CARRIER_CONFIG ) },
    { RIL_REQUEST_OEM_RRC_INFO, std::make_pair(RIL_SERVICE_PS, MSG_PS_RRC_INFO ) },

    //IMS MEDIA
    { RIL_REQUEST_OEM_IMS_TEST_RCM, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_TEST_RCM ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_INIT, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_INIT ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_OPEN_SESSION, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_OPEN_SESSION ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_CLOSE_SESSION, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_CLOSE_SESSION ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_MODIFY_SESSION, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_MODIFY_SESSION ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_SEND_DTMF, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_SEND_DTMF ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_START_DTMF, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_START_DTMF ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_STOP_DTMF, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_STOP_DTMF ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_SEND_TEXT, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_SEND_TEXT ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_SEND_HEADER_EXTENSION, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_SEND_HEADER_EXTENSION ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_SET_MEDIA_QUALITY_THRESHOLD, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_SET_MEDIA_QUALITY_THRESHOLD ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_GET_OPERATION_MODE, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_GET_OPERATION_MODE ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_WIFI_CONFIG, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_WIFI_CONFIG_REQ ) },
    { RIL_REQUEST_OEM_IMS_MEDIA_QUERY_MAC_CE_INFO, std::make_pair(RIL_SERVICE_IMS, MSG_IMS_MEDIA_QUERY_MAC_CE_INFO) },
};
