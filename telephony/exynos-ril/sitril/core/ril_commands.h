...
RouteMap s_RilRequestServiceMap = {
    ...
    { RIL_REQUEST_GET_IMSI, std::make_pair(RIL_SERVICE_SIM_IO, MSG_SIM_GET_IMSI ) },
    ...
    { RIL_REQUEST_SIM_IO, std::make_pair(RIL_SERVICE_SIM_IO, MSG_SIM_IO ) },
    ...
    { RIL_REQUEST_SET_MUTE, std::make_pair(RIL_SERVICE_AUDIO, MSG_CS_SOUND_SET_MUTE ) },
    { RIL_REQUEST_GET_MUTE, std::make_pair(RIL_SERVICE_AUDIO, MSG_CS_SOUND_GET_MUTE ) },
    ...
    { RIL_REQUEST_SET_UICC_SUBSCRIPTION, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_SET_UICC) },
    ...
    /* added in RIL_VERSION 16 */
    { RIL_REQUEST_SLICING_CONFIG, std::make_pair(RIL_SERVICE_PS, MSG_PS_SLICING_CONFIG ) },

    { RIL_REQUEST_ENABLE_UICC_APPLICATIONS, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_ENABLE_UICC_APP) },
    { RIL_REQUEST_GET_UICC_APPLICATIONS_ENABLEMENT, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_GET_UICC_APP_ENABLEMENT) },
    { RIL_REQUEST_SET_SYSTEM_SELECTION_CHANNELS, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_SYSTEM_SELECTION_CHANNELS) },
    { RIL_REQUEST_GET_BARRING_INFO, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_BARRING_INFO) },
    { RIL_REQUEST_SUPPLY_SIM_DEPERSONALIZATION, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_DEPERSONALIZATION) },

    { RIL_REQUEST_NV_READ_ITEM, std::make_pair(-1, 0 ) },
    { RIL_REQUEST_NV_WRITE_ITEM, std::make_pair(-1, 0 ) },
    { RIL_REQUEST_NV_RESET_CONFIG, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_NV_RESET_CONFIG) },
    ...
    {RIL_REQUEST_GET_SIM_PHONEBOOK_RECORDS, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_GET_PHONEBOOK_RECORDS) },
    {RIL_REQUEST_GET_SIM_PHONEBOOK_CAPACITY, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_GET_PHONEBOOK_CAPACITY) },
    {RIL_REQUEST_UPDATE_SIM_PHONEBOOK_RECORDS, std::make_pair(RIL_SERVICE_SIM, MSG_SIM_UPDATE_PB_ENTRY) },
    ...
    {RIL_LOCAL_REQUEST_VSIM_NOTIFICATION, std::make_pair(-1, 0 ) },
    {RIL_LOCAL_REQUEST_VSIM_OPERATION, std::make_pair(-1, 0 ) },
    ...
    { RIL_REQUEST_SET_NR_MODE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_NR_MODE) },
    { RIL_REQUEST_GET_NR_MODE, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_NR_MODE) },
    { RIL_REQUEST_ENABLE_NR_DUAL_CONNECTIVITY, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_OEM_SET_ENDC_MODE) },
    { RIL_REQUEST_IS_NR_DUAL_CONNECTIVITY_ENABLED, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_OEM_GET_ENDC_MODE) },
    { RIL_REQUEST_SET_ALLOWED_NETWORK_TYPES_BITMAP, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_ALLOWED_NETWORK) },
    { RIL_REQUEST_GET_ALLOWED_NETWORK_TYPES_BITMAP, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_ALLOWED_NETWORK) },
    { RIL_REQUEST_SET_USAGE_SETTING, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_USAGE_SETTING) },
    { RIL_REQUEST_GET_USAGE_SETTING, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_USAGE_SETTING) },
    ...
    { RIL_REQUEST_CDMA_SEND_SMS_EXPECT_MORE, std::make_pair(RIL_SERVICE_SMS, MSG_SMS_CDMA_SEND_EXPECT_MORE ) },
    ...
    { RIL_REQUEST_SET_DATA_THROTTLING, std::make_pair(RIL_SERVICE_MISC, MSG_MISC_SET_DATA_THROTTLING) },
    { RIL_REQUEST_ALLOCATE_PDU_SESSION_ID, std::make_pair(RIL_SERVICE_PS, MSG_PS_ALLOC_PDU_SESSION) },
    { RIL_REQUEST_RELEASE_PDU_SESSION_ID, std::make_pair(RIL_SERVICE_PS, MSG_PS_REL_PDU_SESSION) },
    { RIL_REQUEST_START_HANDOVER, std::make_pair(RIL_SERVICE_PS, MSG_PS_START_HANDOVER) },
    { RIL_REQUEST_CANCEL_HANDOVER, std::make_pair(RIL_SERVICE_PS, MSG_PS_CANCEL_HANDOVER) },
    { RIL_REQUEST_GET_SYSTEM_SELECTION_CHANNELS, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_SYSTEM_SELECTION_CHANNELS) },

    { RIL_REQUEST_ENABLE_VONR, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_SET_VONR_ENABLED) },
    { RIL_REQUEST_IS_VONR_ENABLED, std::make_pair(RIL_SERVICE_NETWORK, MSG_NET_GET_VONR_ENABLED) },
};
