...
public:
    ...
    static RequestData *CreateOemSignalStrengthReportingCriteria(int id, Token tok, char *data, unsigned int datalen);
    ...
    static RequestData *CreateSystemSelectionChannels(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateSetUrspData(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateDataThrottling(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateSlotPortMapping(int id, Token tok, char *data, unsigned int datalen);
    ...
    static RequestData *OemCreateStrings(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateUpdateImsRegistrationInfo(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateStartImsTraffic(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateTriggerEpsFallback(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *CreateSrvccCallInfo(int id, Token tok, char *data, unsigned int datalen);
    static RequestData *OemCreateSrvccCallInfo(int id, Token tok, char *data, unsigned int datalen);
