...
/*
 * rilexternalresponselistener.h
 *
 *  Created on: 2014. 11. 20.
 *      Author: sungwoo48.choi
 */

#ifndef    __RIL_EXTERNAL_RESPONSE_LISTENER_H__
#define    __RIL_EXTERNAL_RESPONSE_LISTENER_H__
...
class RilExternalResponseListener : public RilApplicationContext
{
    DECLARE_MODULE_TAG()
private:
...
public:
    RilExternalResponseListener(const struct RIL_External_Env *pRilExternalEnv);
    virtual ~RilExternalResponseListener();
...
public:
    // response
    void OnRequestComplete(RIL_External_Token t, RIL_Errno e, void *response, unsigned int responselen);
    ...
    void OnRequestAck(RIL_External_Token t);
...
#endif // __RIL_EXTERNAL_RESPONSE_LISTENER_H__
