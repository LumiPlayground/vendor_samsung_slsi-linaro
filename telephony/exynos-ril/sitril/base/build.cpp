...
bool Build::IS_ENG = TextUtils::Equals(Build::Type(), string("eng"));
bool Build::IS_USERDEBUG = TextUtils::Equals(Build::Type(), string("userdebug"));
bool Build::IS_USER = TextUtils::Equals(Build::Type(), string("user"));
