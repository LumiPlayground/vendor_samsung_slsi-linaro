...
// This will be replaced with DataProfile
class ApnSetting
{
private:
...
public:
    bool CanHandleType(const int apnTypeBitmask);
    ...
    const char *GetTypeString() const { return m_type; }
    ...
    bool isPcscfRequiredForDefaultPDN();
