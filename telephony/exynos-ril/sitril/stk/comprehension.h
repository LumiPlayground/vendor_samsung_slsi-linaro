...
public:
    ...
    Comprehension(const Comprehension &) = delete;
    Comprehension& operator=(Comprehension const&) = delete;
    virtual ~Comprehension();

    virtual Comprehension *Clone();

    void Set(const BYTE *pData, int nLength);
    void Set(std::vector<CTLV *> vectorTlvs);
