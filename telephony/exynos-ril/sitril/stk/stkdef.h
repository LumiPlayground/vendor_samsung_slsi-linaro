...
typedef enum eComprehensionTlvTag {
    ...
    TAG_TONE = 0x0E,
    TAG_HELP_REQUEST = 0x15,
    TAG_DEFAULT_TEXT = 0x17,
    TAG_EVENT_LIST = 0x19,
    TAG_ICON_IDENTIFIER = 0x1E,
    TAG_TIMER_IDENTIFIER = 0x24,
    TAG_DTMF_STRING = 0x2c,
    ...
    TAG_TEXT_ATTRIBUTE = 0x50,
    TAG_FRAME_IDENTIFIER = 0x68,
    TAG_UTRAN_EUTRAN_MEASUREMENT_QUALIFIER,
    TAG_CSG_ID_LIST = 0x7E,
    TAG_PROACTIVE_COMMAND = 0x50,
    TAG_ITEM_IDENTIFIER = 0x0f,
    TAG_ITEM_ID_IDENTIFIER = 0x10,
    TAG_URL = 0x31,
    TAG_BROWSER_TERMINATION_CAUSE = 0x34,
    TAG_IMMEDIATE_RESPONSE = 0x2B,
    TAG_LANGUAGE = 0x2d,
...
typedef struct tagDefaultText {
    BYTE cCodingScheme;
    BYTE acDefaultTextString[0];
} DEFAULT_TEXT;
