...
public class VsimService extends Service {
    ...
    private void connectToOemRilService() {
        ...
        filters.add(OemRilConstants.RILC_UNSOL_VSIM_OPERATION);

        mOemRil[0] = OemRil.init(getApplicationContext(), SIM1, "VSimService", filters);
        mOemRil[1] = OemRil.init(getApplicationContext(), SIM2, "VSimService", filters);
