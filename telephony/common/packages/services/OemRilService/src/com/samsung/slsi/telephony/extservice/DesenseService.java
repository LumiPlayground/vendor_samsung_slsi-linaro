...
public class DesenseService extends Service {
    ...
    private void connectToOemRilService() {
        ...
        filters.add(OemRilConstants.RILC_UNSOL_SCAN_RSSI_RESULT);
        filters.add(OemRilConstants.RILC_UNSOL_FORWARDING_AT_COMMAND);

        mOemRil[0] = OemRil.init(getApplicationContext(), 0, "DesenseService", filters);
        mOemRil[1] = OemRil.init(getApplicationContext(), 1, "DesenseService", filters);
