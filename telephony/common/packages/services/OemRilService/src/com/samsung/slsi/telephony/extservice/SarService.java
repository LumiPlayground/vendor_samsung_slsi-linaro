...
public class SarService extends Service {
    ...
    private void connectToOemRilService() {
        ...
        filters.add(OemRilConstants.RILC_UNSOL_SAR_RF_CONNECTION);

        mOemRil[0] = OemRil.init(getApplicationContext(), SIM1, "SarService", filters);
        mOemRil[1] = OemRil.init(getApplicationContext(), SIM2, "SarService", filters);
