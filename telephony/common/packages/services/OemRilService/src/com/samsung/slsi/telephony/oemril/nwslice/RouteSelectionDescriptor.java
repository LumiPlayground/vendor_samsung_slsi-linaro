...
public final class RouteSelectionDescriptor implements Parcelable {
    ...
    /** @hide */
    RouteSelectionDescriptor(vendor.samsung_slsi.telephony.hardware.radio.V1_2.RouteSelectionDescriptor rsd) {
    ...
    public RouteSelectionDescriptor(int precedence, int sessionType, int sscMode,
            List<vendor.samsung_slsi.telephony.hardware.radio.V1_2.SliceInfo> sliceInfo, List<String> dnn) {
