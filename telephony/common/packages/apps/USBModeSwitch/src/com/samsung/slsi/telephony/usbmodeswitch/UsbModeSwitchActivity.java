...
public class UsbModeSwitchActivity extends PreferenceActivity implements Preference.OnPreferenceChangeListener {
    ...
    protected void onCreate(Bundle saveInstance) {
        ...
        mUsbModePref.setSummary(mUsbModePref.getValue());
    }
    ...
    public void updateCurrentUsbMode() {
        ...
        Log.d(TAG, "current USB mode : " + currentFunctions);
        if (!TextUtils.isEmpty(mUsbModePref.getValue()) && !currentFunctions.contains(mUsbModePref.getValue())) {
            Log.d(TAG, "update USB mode : " + currentFunctions);
