...
oneway interface IDMControlService {
    ...
    /*
     * setTcpDumpModeForAutoLogging
     * tcpDumpEnable : 0=disable, 1=enable
     * headerDumpEnable : 0=default, 1=header size capture
     */
    void setTcpDumpModeForAutoLogging(in int tcpDumpEnable, in int headerDumpEnable);
