...
//                    startService(intent);
        ...
        btnStartAuto.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    mDMControlService.startAutoLogging(SystemProperties.getInt(SilentLoggingConstant.PROPERTY_AUTOLOG_MAXSIZE, SilentLoggingConstant.AUTOLOG_SIZE_MIN));
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
            }
        ...
        btnStartAutoProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    mDMControlService.startAutoLoggingWithProfile(SystemProperties.getInt(SilentLoggingConstant.PROPERTY_AUTOLOG_MAXSIZE, 32), "/sdcard/DCIM/sample.prx");
                } catch (RemoteException e) {
                    e.printStackTrace();
                }
            }
