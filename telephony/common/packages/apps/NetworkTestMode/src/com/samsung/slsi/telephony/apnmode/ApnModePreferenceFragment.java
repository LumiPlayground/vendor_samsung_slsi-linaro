...
public class ApnModePreferenceFragment extends PreferenceFragment {
    ...
    private void fillList() {
        ...
        if (root != null) {
            ...
            Cursor cursor = getContext().getContentResolver().query(
                    CONTENT_URI,
                    new String[] { "_id", "name", "apn", "type", "numeric" },
            ...
            if (cursor != null) {
                ...
                cursor.close();
                Toast.makeText(getContext(), "numeric = " + numeric,
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        Uri uri = ContentUris.withAppendedId(CONTENT_URI,
                Integer.parseInt(switch_pref.getKey()));
        ...
        if (type.contains("default")) {
            ...
            if (switch_pref.isChecked()) {
                cm.requestNetwork(getNetworkRequest(type),
                        mNetworkCallback.get(switch_pref.getOrder()));
            } else {
                try {
                    cm.unregisterNetworkCallback(mNetworkCallback
                            .get(switch_pref.getOrder()));
                } catch (Exception e) {
        ...
        // values.put(ApnModeConstants.CARRIER_ENABLED, switch_pref.isChecked()
        // ? 1 : 0);
