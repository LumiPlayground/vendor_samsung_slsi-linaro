...
public class VoLteModePreferenceFragment extends PreferenceFragment implements
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            case EVENT_SET_PREF_CALL_CAPA:
                if (ar.exception == null) {
                    mVoLteListPref.setSummary(mVoLteListPref.getEntry());
                    mCurMode = mVoLteListPref.findIndexOfValue(mVoLteListPref
                            .getValue());
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mVoLteListPref = (ListPreference) getPreferenceScreen().findPreference(
                "key_volte_mode");
    ...
    private void setVoLteMode(int mode) {
        ...
        mOemRil.invokeRequestRaw(RILC_REQ_MISC_SET_PREFERRED_CALL_CAPA,
                dr.toByteArray(),
                mHandler.obtainMessage(EVENT_SET_PREF_CALL_CAPA));
    }

    private void getVoLteMode() {
        mOemRil.invokeRequestRaw(RILC_REQ_MISC_GET_PREFERRED_CALL_CAPA, null,
                mHandler.obtainMessage(EVENT_GET_PREF_CALL_CAPA));
    }
