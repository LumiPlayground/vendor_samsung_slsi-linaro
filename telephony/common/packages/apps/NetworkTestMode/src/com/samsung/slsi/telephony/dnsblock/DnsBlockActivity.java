...
public class DnsBlockActivity extends PreferenceActivity implements
    ...
    private void updateCurrentMode() {
        String mode = String.valueOf(SystemProperties.get(PROPERTY_DNS_BLOCK,
                "0"));
        if (mode.equals("1")) {
            Toast.makeText(getApplicationContext(), "DNS: Block",
