...
public class SelectSimPreferenceFragment extends PreferenceFragment {
    ...
    public void onResume() {
        ...
        String simOperator1 = TelephonyManager.from(getContext())
        ...
        if (TelephonyManager.getDefault().isMultiSimEnabled()) {
            String simOperator2 = TelephonyManager.from(getContext())
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen,
        ...
        UrspSettingActivity activity = (UrspSettingActivity) getActivity();
