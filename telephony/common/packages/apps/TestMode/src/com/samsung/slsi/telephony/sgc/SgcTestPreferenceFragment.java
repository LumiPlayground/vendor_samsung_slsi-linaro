...
public class SgcTestPreferenceFragment extends PreferenceFragment implements Preference.OnPreferenceChangeListener {
    ...
    private ListPreference mSgcGlobalListPref, mSgcLatamListPref, mSgcNaListPref, mSgcKorListPref;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mSgcKorListPref = (ListPreference) findPreference("key_sgc_kor");
        mSgcKorListPref.setOnPreferenceChangeListener(this);
    }
    ...
    private void updateCurrentMode() {
        ...
        if (mode.equals("")) {
            ...
            pos = mSgcKorListPref.findIndexOfValue(mode);
            if (pos >= 0 ) {
                mSgcKorListPref.setSummary(mSgcKorListPref.getEntries()[pos]);
                mSgcKorListPref.setValueIndex(pos);
            } else {
                mSgcKorListPref.setSummary("");
                mSgcKorListPref.setValueIndex(0);
            }
        }
    }
