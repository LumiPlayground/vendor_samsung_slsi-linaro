...
enum {
    ...
    MODE_EXTERNAL_DM,
    MODE_SILENT_LOGGING,
    MODE_ON_BOARD_DM,  // deprecated
    MODE_ON_BOARD_APP,
    MODE_FACTORY_LOGGING,
};
...
enum {
    ...
    COMMAND_SET_DM_MAX_NUM_OF_FILE = 8,
    COMMAND_SET_DM_BASE_DIRECTORY = 9,
    COMMAND_SET_DM_FILENAME_PREFIX = 10,
    COMMAND_SET_USER_DEFINED_HEADER = 11,
