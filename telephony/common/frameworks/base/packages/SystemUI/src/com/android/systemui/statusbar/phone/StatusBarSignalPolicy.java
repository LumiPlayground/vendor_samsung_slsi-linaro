...
public class StatusBarSignalPolicy implements SignalCallback,
    ...
    public void setMobileDataIndicators(@NonNull MobileDataIndicators indicators) {
        ...
        state.voiceTypeId = indicators.voiceStatusType;
        ...
        state.imsRegistration = indicators.isImsReg;
        state.activityIn = indicators.activityIn && mActivityEnabled;
        state.activityOut = indicators.activityOut && mActivityEnabled;

        int iconId = 0;
        if (mNetworkController.getMobileDataConnected(indicators.subId)) { // This will embed sim state
            if(indicators.activityIn && indicators.activityOut)
                iconId = R.drawable.ic_stat_signal_inout;
            else if(indicators.activityIn)
                iconId = R.drawable.ic_stat_signal_in;
            else if(indicators.activityOut)
                iconId = R.drawable.ic_stat_signal_out;
            else
                iconId = R.drawable.ic_stat_signal_no_inout; // This include CDMA DORMANT
        }

        state.mDataDirectIconId = iconId;
    ...
    private static abstract class SignalIconState {
        ...
        public int mDataDirectIconId = 0;
        ...
        public boolean equals(Object o) {
            ...
            return visible == that.visible &&
                    ...
                    mDataDirectIconId == that.mDataDirectIconId;
        }
        ...
        protected void copyTo(SignalIconState other) {
            ...
            other.mDataDirectIconId = mDataDirectIconId;
        }
    }
    ...
    public static class MobileIconState extends SignalIconState {
        ...
        public int typeId, voiceTypeId;
        public boolean showTriangle;
        public boolean roaming;
        public boolean imsRegistration;
        ...
        public boolean equals(Object o) {
            ...
            return subId == that.subId
                    ...
                    && typeId == that.typeId
                    && voiceTypeId == that.voiceTypeId
                    && showTriangle == that.showTriangle
                    && roaming == that.roaming
                    && imsRegistration == that.imsRegistration
        ...
        public int hashCode() {
            ...
            return Objects
                    .hash(super.hashCode(), subId, strengthId, typeId, voiceTypeId, showTriangle, roaming,
                            imsRegistration, needsLeadingPadding, typeContentDescription);
        }
        ...
        public void copyTo(MobileIconState other) {
            ...
            other.typeId = typeId;
            other.voiceTypeId = voiceTypeId;
            other.showTriangle = showTriangle;
            other.roaming = roaming;
            other.imsRegistration = imsRegistration;
        ...
        @Override public String toString() {
            return "MobileIconState(subId=" + subId + ", strengthId=" + strengthId
                    + ", showTriangle=" + showTriangle + ", roaming=" + roaming + ", imsRegistration=" + imsRegistration
                    + ", typeId=" + typeId + ", voiceTypeId=" + voiceTypeId + ", visible=" + visible + ")";
        }
    }
}
