...
public class MobileStatusTracker {
    private static final String TAG = "ExynosMobileStatusTracker";
    ...
    public class MobileTelephonyCallback extends TelephonyCallback implements
        ...
        public void onSrvccStateChanged(int state) {
            Log.d(TAG, "onSrvccStateChanged: state=" + state);
            mMobileStatus.currentSrvcc = state;
            mCallback.onMobileStatusChanged(
                    /* updateTelephony= */ true, new MobileStatus(mMobileStatus));
        }
        ...
        public void onCallStateChanged(int state) {
            ...
            if (state == TelephonyManager.CALL_STATE_IDLE) {
                mMobileStatus.currentSrvcc = TelephonyManager.SRVCC_STATE_HANDOVER_NONE;
                mCallback.onMobileStatusChanged(
                        /* updateTelephony= */ true, new MobileStatus(mMobileStatus));
            }
        }
    ...
    public static class MobileStatus {
        ...
        public int currentSrvcc = TelephonyManager.SRVCC_STATE_HANDOVER_NONE;
        ...
        protected void copyFrom(MobileStatus status) {
            ...
            currentSrvcc = status.currentSrvcc;
        ...
        public String toString() {
            ...
            return builder.append("[activityIn=").append(activityIn).append(',')
                ...
                .append("currentSrvcc=").append(currentSrvcc).append(',')
