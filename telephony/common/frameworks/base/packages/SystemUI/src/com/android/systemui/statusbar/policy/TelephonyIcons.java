...
public class TelephonyIcons {
    ...
    public static final int ICON_3G_PLUS = R.drawable.stat_sys_data_fully_connected_3g;
    ...
    public static final int ICON_4G_LTE = R.drawable.stat_sys_data_fully_connected_4g_lte;
    ...
    public static final int ICON_5G_E = R.drawable.stat_sys_data_fully_connected_5g_e;
    public static final int ICON_5G = R.drawable.stat_sys_data_fully_connected_5g;
    public static final int ICON_5G_PLUS = R.drawable.stat_sys_data_fully_connected_5g_plus;
    public static final int ICON_5G_UW = R.drawable.stat_sys_data_fully_connected_5g_uw;
    public static final int ICON_5G_UC = R.drawable.stat_sys_data_fully_connected_5g_uc;

    public static final int ICON_DATA_DISABLED = R.drawable.stat_sys_data_disabled;
    public static final int ICON_X = R.drawable.stat_sys_data_fully_connected_x;
    ...
    public static final MobileIconGroup UNKNOWNDATA = new MobileIconGroup(
            "Unknown",
            null,
            null,
            AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH,
    ...
    */
    ...
    public static final MobileIconGroup NR_5G_UW = new MobileIconGroup(
            "5G_UW",
            null,
            null,
            AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH,
            ...
            AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH[0],
            R.string.data_connection_5g_plus,
            TelephonyIcons.ICON_5G_UW
    );

    public static final MobileIconGroup NR_5G_UC = new MobileIconGroup(
            "5G_UC",
            null,
            null,
            AccessibilityContentDescriptions.PHONE_SIGNAL_STRENGTH,
