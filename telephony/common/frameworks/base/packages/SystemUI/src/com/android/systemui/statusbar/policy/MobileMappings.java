...
public class MobileMappings {
    ...
    public static MobileIconGroup getDefaultIcons(Config config) {
        return TelephonyIcons.UNKNOWNDATA;
    }
    ...
    public static Map<String, MobileIconGroup> mapIconSets(Config config) {
        ...
        if (!config.showAtLeast3G) {
            ...
            networkToIconLookup.put(toIconKey(TelephonyManager.NETWORK_TYPE_GPRS),
                    TelephonyIcons.G);
            networkToIconLookup.put(toIconKey(TelephonyManager.NETWORK_TYPE_IDEN),
                    TelephonyIcons.G);
            networkToIconLookup.put(toIconKey(TelephonyManager.NETWORK_TYPE_GSM),
                    TelephonyIcons.G);
        ...
        if (config.show5guwIcon) {
            networkToIconLookup.put(toDisplayIconKey(
                    TelephonyDisplayInfo.OVERRIDE_NETWORK_TYPE_NR_ADVANCED),
                    TelephonyIcons.NR_5G_UW);
        } else if (config.show5gucIcon) {
            networkToIconLookup.put(toDisplayIconKey(
                    TelephonyDisplayInfo.OVERRIDE_NETWORK_TYPE_NR_ADVANCED),
                    TelephonyIcons.NR_5G_UC);
        } else {
            networkToIconLookup.put(toDisplayIconKey(
                    TelephonyDisplayInfo.OVERRIDE_NETWORK_TYPE_NR_ADVANCED),
    ...
    public static class Config {
        ...
        public boolean show5guwIcon = false;
        public boolean show5gucIcon = false;
        public boolean checkRoamForBothofVoiceAndData = false;
        public boolean hideRoamingIcon = false;
        ...
        public static Config readConfig(Context context) {
            ...
            if (b != null) {
                ...
                config.show5guwIcon = b.getBoolean("show_5guw_icon_bool", false);
                config.show5gucIcon = b.getBoolean("show_5guc_icon_bool", false);
                config.checkRoamForBothofVoiceAndData = b.getBoolean(
                        "check_roaming_state_for_both_of_voice_and_data_bool", false);
                config.hideRoamingIcon = b.getBoolean("hide_roaming_icon_bool", false);
            }
            return config;
        }
    }
