...
public class QSPanelController extends QSPanelControllerBase<QSPanel>
        implements QSHost.OnAirplaneModeListener {
    ...
    protected void onViewAttached() {
        ...
        mHost.regAirplaneModeListener(this);
    }
    ...
    protected void onViewDetached() {
        ...
        mHost.unRegAirplaneModeListener(this);
    }
    ...
    public void onAirplaneModeChanged() {
        for (TileRecord r : getRecords()) {
            if (r.tile instanceof AirplaneModeTile) {
                (r.tileView).setEnabled(false);
            }
        }
    }
