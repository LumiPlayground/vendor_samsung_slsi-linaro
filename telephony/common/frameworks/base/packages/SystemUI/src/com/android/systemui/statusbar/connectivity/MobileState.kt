...
internal class MobileState(
    ...
    @JvmField var imsRegistration: Boolean = false
) : ConnectivityState() {
    ...
    override fun copyFrom(other: ConnectivityState) {
        ...
        imsRegistration = o.imsRegistration
    ...
    override fun toString(builder: StringBuilder) {
        ...
        builder.append("imsRegistration=$imsRegistration,")
    ...
    override fun tableData(): List<String> {
        val columns = listOf(dataSim,
                ...
                imsRegistration).map { it.toString() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (imsRegistration != other.imsRegistration) return false
    ...
    override fun hashCode(): Int {
        ...
        result = 31 * result + imsRegistration.hashCode()
        return result
    }
}
