...
public class WifiIcons {
    ...
    static final int[] WIFI6_FULL_ICONS = {
    ...
    private static final int[] WIFI6_NO_INTERNET_ICONS = {
            R.drawable.ic_no_internet_wifi6_signal_0,
            R.drawable.ic_no_internet_wifi6_signal_1,
            R.drawable.ic_no_internet_wifi6_signal_2,
            R.drawable.ic_no_internet_wifi6_signal_3,
            R.drawable.ic_no_internet_wifi6_signal_4
    };
    ...
    public static final int[][] QS_WIFI6_SIGNAL_STRENGTH = {
            WIFI6_NO_INTERNET_ICONS,
            WIFI6_FULL_ICONS
    };

    static final int[][] WIFI_SIGNAL_STRENGTH = QS_WIFI_SIGNAL_STRENGTH;

    static final int[][] WIFI6_SIGNAL_STRENGTH = QS_WIFI6_SIGNAL_STRENGTH;
    ...
    public static final int QS_WIFI6_NO_NETWORK = R.drawable.ic_wifi6_signal_0;
    static final int WIFI_NO_NETWORK = QS_WIFI_NO_NETWORK;
    static final int WIFI6_NO_NETWORK = QS_WIFI6_NO_NETWORK;
    ...
    public static final IconGroup UNMERGED_WIFI6 = new IconGroup(
            "Wi-Fi6 Icons",
            WifiIcons.WIFI6_SIGNAL_STRENGTH,
            WifiIcons.QS_WIFI6_SIGNAL_STRENGTH,
            AccessibilityContentDescriptions.WIFI_CONNECTION_STRENGTH,
            WifiIcons.WIFI6_NO_NETWORK,
            WifiIcons.QS_WIFI6_NO_NETWORK,
            WifiIcons.WIFI6_NO_NETWORK,
            WifiIcons.QS_WIFI6_NO_NETWORK,
            AccessibilityContentDescriptions.WIFI_NO_CONNECTION
    );
