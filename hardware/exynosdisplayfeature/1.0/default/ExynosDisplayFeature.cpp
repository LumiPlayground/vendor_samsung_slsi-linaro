...
Return<::vendor::samsung_slsi::hardware::exynosdisplayfeature::V1_0::Status> ExynosDisplayFeature::setHDR(int32_t displayId, int32_t caseId, int32_t modeId, int32_t cookie) {
    // TODO implement
    ALOGD("setFeature (%d %d %d %d)", displayId, caseId, modeId, cookie);
    handleHDR(displayId, caseId, modeId, cookie);
