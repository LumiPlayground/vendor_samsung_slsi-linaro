...
void BpHwSupplicantVendorStaIface::onLastStrongRef(const void* id) {
    {
        std::unique_lock<std::mutex> lock(_hidl_mMutex);
        _hidl_mDeathRecipients.clear();
    }

    BpInterface<ISupplicantVendorStaIface>::onLastStrongRef(id);
}
// Methods from ::vendor::samsung_slsi::hardware::wifi::supplicant::V1_0::ISupplicantVendorStaIface follow.
::android::hardware::Return<void> BpHwSupplicantVendorStaIface::_hidl_registerVendorCallback(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::sp<::vendor::samsung_slsi::hardware::wifi::supplicant::V1_0::ISupplicantVendorStaIfaceCallback>& callback, registerVendorCallback_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ISupplicantVendorStaIface::registerVendorCallback::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* registerVendorCallback */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
...
::android::status_t BnHwSupplicantVendorStaIface::_hidl_registerVendorCallback(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ISupplicantVendorStaIface*>(_hidl_this->getImpl().get())->registerVendorCallback(callback, [&](const auto &_hidl_out_status) {
