...
void BpHwSupplicantVendorStaIfaceCallback::onLastStrongRef(const void* id) {
    {
        std::unique_lock<std::mutex> lock(_hidl_mMutex);
        _hidl_mDeathRecipients.clear();
    }

    BpInterface<ISupplicantVendorStaIfaceCallback>::onLastStrongRef(id);
}
// Methods from ::vendor::samsung_slsi::hardware::wifi::supplicant::V1_0::ISupplicantVendorStaIfaceCallback follow.
::android::hardware::Return<void> BpHwSupplicantVendorStaIfaceCallback::_hidl_onVendorDriverHang(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::hidl_string& state, const ::android::hardware::hidl_string& msg) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ISupplicantVendorStaIfaceCallback::onVendorDriverHang::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* onVendorDriverHang */, _hidl_data, &_hidl_reply, 0 /* flags */ | 1u /* oneway */);
...
::android::status_t BnHwSupplicantVendorStaIfaceCallback::_hidl_onVendorDriverHang(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ISupplicantVendorStaIfaceCallback*>(_hidl_this->getImpl().get())->onVendorDriverHang(*state, *msg);
