...
void BpHwSupplicantVendor::onLastStrongRef(const void* id) {
    {
        std::unique_lock<std::mutex> lock(_hidl_mMutex);
        _hidl_mDeathRecipients.clear();
    }

    BpInterface<ISupplicantVendor>::onLastStrongRef(id);
}
// Methods from ::vendor::samsung_slsi::hardware::wifi::supplicant::V1_0::ISupplicantVendor follow.
::android::hardware::Return<void> BpHwSupplicantVendor::_hidl_getVendorInterface(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, const ::android::hardware::wifi::supplicant::V1_0::ISupplicant::IfaceInfo& ifaceInfo, getVendorInterface_cb _hidl_cb) {
    ...
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ISupplicantVendor::getVendorInterface::client");
    #ifdef __ANDROID_DEBUGGABLE__
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(1 /* getVendorInterface */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
...
::android::hardware::Return<void> BpHwSupplicantVendor::_hidl_listVendorInterfaces(::android::hardware::IInterface *_hidl_this, ::android::hardware::details::HidlInstrumentor *_hidl_this_instrumentor, listVendorInterfaces_cb _hidl_cb) {
    ...
    (void) _hidl_this_instrumentor;
    #endif // __ANDROID_DEBUGGABLE__
    ::android::ScopedTrace PASTE(___tracer, __LINE__) (ATRACE_TAG_HAL, "HIDL::ISupplicantVendor::listVendorInterfaces::client");
    #ifdef __ANDROID_DEBUGGABLE__
    if (UNLIKELY(mEnableInstrumentation)) {
        std::vector<void *> _hidl_args;
        for (const auto &callback: mInstrumentationCallbacks) {
    ...
    _hidl_transact_err = ::android::hardware::IInterface::asBinder(_hidl_this)->transact(2 /* listVendorInterfaces */, _hidl_data, &_hidl_reply, 0 /* flags */, [&] (::android::hardware::Parcel& _hidl_reply) {
        ::android::hardware::wifi::supplicant::V1_0::SupplicantStatus* _hidl_out_status;
...
::android::status_t BnHwSupplicantVendor::_hidl_getVendorInterface(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ISupplicantVendor*>(_hidl_this->getImpl().get())->getVendorInterface(*ifaceInfo, [&](const auto &_hidl_out_status, const auto &_hidl_out_iface) {
...
::android::status_t BnHwSupplicantVendor::_hidl_listVendorInterfaces(
    ...
    ::android::hardware::Return<void> _hidl_ret = static_cast<ISupplicantVendor*>(_hidl_this->getImpl().get())->listVendorInterfaces([&](const auto &_hidl_out_status, const auto &_hidl_out_ifaces) {
        if (_hidl_callbackCalled) {
