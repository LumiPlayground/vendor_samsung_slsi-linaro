...
struct ExynosHWCServiceTW : public IExynosHWCServiceTW {
    ...
    public:
        ...
        void clearExynosHWCServiceTW();
        void createExynosHWCServiceTW();
    ...
    private:
        sp<IExynosHWCService> mHwcService = NULL;
        sp<IExynosHWCService> getHwcService();
        sp<IBinder::DeathRecipient> mTWDeathObserver;
};
