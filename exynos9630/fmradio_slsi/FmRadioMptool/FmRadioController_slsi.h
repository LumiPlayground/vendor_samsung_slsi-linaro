...
#define FM_RADIO_RDS_BLCNT_MASK (0x7)
...
public:
    ...
    long GetSoftStereoBlendCoeff();
    long GetSoftMuteCoeff();
    ...
    void SetIFCount1(int threshold);
    void SetIFCount2(int threshold);
    int GetIFCount1();
    int GetIFCount2();
};
