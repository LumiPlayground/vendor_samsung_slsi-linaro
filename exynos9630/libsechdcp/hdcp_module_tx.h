...
class ExynosHDCPModuleTx : public HDCPModule {
public:
...
class HDCPTxHandler :  public AHandler {
public:
    enum {
        kWhatInitAsync,
        kWhatShutdownAsync,
    ...
    HDCPTxHandler(void *cookie, HDCPModule::ObserverFunc observerFunc, int smemFd);
...
private:
    ...
    void *m_Cookie;
    HDCPModule::ObserverFunc mObserverFunc;
    int mSmemFd;
};
